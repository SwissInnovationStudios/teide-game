(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=e(s);fetch(s.href,r)}})();const Jt={sky:12964828,water:3043220,shore:13023631,rock:9077368,snow:15395556,paper:16052712,trunk:7032634,ink:2765624,runway:5591628,pineCanopy:4151864,laurelCanopy:3032880,shrubBody:8160594,grassGround:10858597,cropGround:12100700,urbanGround:10392202,bareGround:10325622,houseWall:15590351,houseRoof:10246468},jt={size:16e3,segments:1200,waterLevel:.1,fogStart:600,fogEnd:3e3,heightmap:{url:"/teide/heightmaps/canaries.png",bbox:{latN:29.5,latS:27.4,lonW:-18.4,lonE:-13.3},center:{lat:28.3,lon:-16.55},metersPerUnit:40,elevRange:[0,4e3]}},ld="TFN",Ao=Object.freeze({startSpeed:22,minSpeed:2,maxSpeed:52,stallSpeed:7,pitchRate:.7,maxClimbPitch:.35,rollRate:1.8,turnFactor:1,speedFromPitch:22,drag:.7,sinkRate:.5,stallSink:9,stallPitchRate:1.9,stallAuthority:.25}),Jr=Object.freeze({startSpeed:22,minSpeed:2,maxSpeed:38,stallSpeed:9,pitchRate:.7,maxClimbPitch:.35,rollRate:1.8,turnFactor:1,speedFromPitch:12,drag:1.2,sinkRate:.5,stallSink:9,stallPitchRate:1.9,stallAuthority:.25}),pe={...Jr},wo=Object.freeze({takeoffSpeed:50,liftoffFraction:.65,linearShare:.15,pitchUpAtLiftoff:.16}),Qr=Object.freeze({takeoffSpeed:32,liftoffFraction:.85,linearShare:.45,pitchUpAtLiftoff:.16}),jn={...Qr},Pi={drag:{kind:"stat",stat:"drag",label:"Aerodynamik",description:"Glättere Faltung — weniger Luftwiderstand, längeres Gleiten.",levels:[1.2,1.05,.9,.78,.7],costs:[0,600,1500,3200,6500]},maxSpeed:{kind:"stat",stat:"maxSpeed",label:"Spitzentempo",description:"Erhöht die maximale Fluggeschwindigkeit im Cruise.",levels:[38,42,46,49,52],costs:[0,800,2e3,4500,9e3]},speedFromPitch:{kind:"stat",stat:"speedFromPitch",label:"Sturzflug",description:"Mehr Beschleunigung im Sturzflug — Höhe wird zu Tempo.",levels:[12,15,18,20,22],costs:[0,500,1300,2800,5500]},stallSpeed:{kind:"stat",stat:"stallSpeed",label:"Stabilität",description:"Tiefere Strömungsabriss-Schwelle — verzeiht langsames Fliegen.",levels:[9,8.5,8,7.5,7],costs:[0,700,1700,3600,7e3]},takeoffSpeed:{kind:"stat",stat:"takeoffSpeed",label:"Startbahn",description:"Schnellere Beschleunigung beim Start — weniger Roll-Strecke.",levels:[32,37,42,46,50],costs:[0,600,1500,3200,6500]},brake:{kind:"unlock",label:"Luftbremse",description:"Schaltet die Bremsklappen frei (Leertaste im Flug).",levels:[!1,!0],costs:[0,2500]}},Co={obsidianPerPunkte:100},ro={force:9,deployTau:.07,maxAngle:1.35},ma={triggerDist:85,triggerHeight:40,deployTau:.35},Ai={brakeForce:14,landingSpeed:2.5,headingTolerance:.45,rollingHeight:1.8,landingBonus:500},Pu={duration:3,startHeight:5e3},Lu={toastDuration:1.4,tweenDuration:2},Je={columnColor:16777215,columnOpacity:.1,columnTop:95,maxAltitude:95,liftAtCenter:30,particleColor:16777215,particleOpacity:.55,particleSize:1.7,particleDensity:.05,riseSpeed:14},We={distance:6.5,height:2.6,lookAhead:3.5,posTau:.12,yawTau:.1,pitchTau:.55,runwayDistance:3,runwayHeight:.4,runwayLookAhead:0},Yn={verts:8,maxLen:2.8},Pe={grey:{color:10132122,tankDuration:1,speedBonus:8,accelRate:35,rechargeTime:20},oneShot:{tiers:[{name:"No Booster",color:0,tankDuration:0,speedBonus:0,accelRate:0},{name:"Booster Level 1",color:5086950,tankDuration:1.2,speedBonus:14,accelRate:45},{name:"Booster Level 2",color:15778888,tankDuration:1.6,speedBonus:20,accelRate:55},{name:"Booster Level 3",color:14702666,tankDuration:2,speedBonus:28,accelRate:70},{name:"Booster Level MAX",color:10905053,tankDuration:2.5,speedBonus:38,accelRate:85}]},refillDuration:1.6,camPushback:2.5,camPushbackTau:.15,exhaust:{offsetX:.36,offsetY:.13,offsetZ:.42,length:1.8,radiusNarrow:.03,radiusWide:.12,intensityTau:.06}},Re={sampleCount:25e5,treeDensity:1,shrubDensity:.85,grassDensity:.7,cropDensity:.6,bareDensity:.85,droughtShrubDensity:.22,snowDensity:.4,wetlandDensity:.5,rockZoneLowMax:2.5,rockZoneHighMin:37.5,laurelMaxAltitude:1500/40,treeScale:.75,urban:{minClusterPixels:3,churchClusterPixels:8,housesPerPixel:.55,housesMin:2,housesMax:30,houseMinSpacing:2.4,pixelJitter:5.5,clusterScaleMin:.9,clusterScaleMax:1.75},grassTints:[[1.05,1.02,.85],[.85,.95,.7],[1,1,1],[.7,.85,.55],[1.1,1.05,.75],[.95,.9,.8]],rockTintsLow:[[1.2,1.18,1.1],[1.05,.95,.78],[.95,.9,.8],[1.1,1.05,.95],[1.15,1,.82]],rockTintsMid:[[.55,.55,.6],[.45,.45,.5],[.7,.68,.62],[.85,.78,.65],[.5,.52,.55],[.65,.6,.55]],rockTintsHigh:[[1.15,.95,.8],[1.05,.9,.75],[.95,.85,.75],[1.2,1,.85],[.85,.65,.55]],roofTints:[[1,1,1],[.88,.86,.88],[.62,.58,.68],[1.1,.95,.85],[.95,.88,.78]]},oe={ring:{majorRadius:2,tubeRadius:.12,hoverHeight:8,opacity:.85,opacityActivated:.3,colorActivated:7235682},symbol:{size:1.4,extrudeDepth:.22,rotRate:.7,colorActivated:10132122},activation:{radius:2},colorsByType:{peak:{ring:7235682,symbol:9077368},city:{ring:12155486,symbol:15590351},landscape:{ring:5139274,symbol:9283182},beach:{ring:5212840,symbol:15129016}},rewardsByType:{peak:{punkte:800,gofios:5},city:{punkte:400,gofios:1},landscape:{punkte:500,gofios:2},beach:{punkte:400,gofios:1}},tierThresholds:[0,5,25,55,80],hoverLabelRadius:80,activationToast:{duration:3}},ne={INTRO:"INTRO",PRELAUNCH:"PRELAUNCH",TAKEOFF_ROLL:"TAKEOFF_ROLL",FLYING:"FLYING",LANDING_ROLL:"LANDING_ROLL",LANDED:"LANDED",CRASHED:"CRASHED"},G={speed:pe.startSpeed,alive:!0,inThermal:!1,brakeAmount:0,gearAmount:0,flightState:ne.PRELAUNCH,currentRunway:null,takeoffTime:0,postLiftCooldown:0,landedToastTimer:0,cinematicT:0,cinematicFromPos:null,cinematicToPos:null,cinematicFromQuat:null,cinematicToQuat:null,introT:0,introStartCamPos:null,greyActive:!1,oneShotActive:!1,prevOneShot:!1,boostFuelGrey:1,boostFuelOneshot:0,refillT:1,refillStartGrey:1,refillStartOneshot:0,flightPunkte:0,boosterOverride:null},St={punkte:0,gofiosByIsland:{tenerife:0,gomera:0,palma:0,gc:0,hierro:0,fuerte:0,lanza:0,graciosa:0},obsidian:0,landings:0,bestFlightPunkte:0,upgrades:{drag:0,maxSpeed:0,speedFromPitch:0,stallSpeed:0,takeoffSpeed:0,brake:0},oneShotTierByIsland:{tenerife:0,gomera:0,palma:0,gc:0,hierro:0,fuerte:0,lanza:0,graciosa:0},exploredPOIs:{},checkpointRunwayId:null,introPlayed:!1,currentIsland:"tenerife",testMode:!1};function ta(n){St.punkte+=n,G.flightPunkte+=n}function cd(){G.speed=pe.startSpeed,G.alive=!0,G.inThermal=!1,G.brakeAmount=0,G.gearAmount=0,G.flightState=ne.PRELAUNCH,G.currentRunway=null,G.takeoffTime=0,G.postLiftCooldown=0,G.landedToastTimer=0,G.cinematicT=0,G.cinematicFromPos=null,G.cinematicToPos=null,G.cinematicFromQuat=null,G.cinematicToQuat=null,G.introT=0,G.introStartCamPos=null,G.greyActive=!1,G.oneShotActive=!1,G.prevOneShot=!1}function ud(n){return n in Jr?pe:n in Qr?jn:null}function qs(){if(St.testMode){Object.assign(pe,Ao),Object.assign(jn,wo);return}Object.assign(pe,Jr),Object.assign(jn,Qr);for(const[n,t]of Object.entries(Pi)){if(t.kind!=="stat")continue;const e=St.upgrades?.[n]|0,i=Math.max(0,Math.min(t.levels.length-1,e)),s=ud(t.stat);s&&(s[t.stat]=t.levels[i])}}function wi(n=St.currentIsland){return St.testMode?G.boosterOverride!=null?G.boosterOverride:4:St.oneShotTierByIsland?.[n]|0}function hd(){return St.testMode?!0:!!St.upgrades?.brake}function dd(n){for(const[t,e]of Object.entries(Pi)){if(e.kind!=="stat"||e.stat!==n)continue;const i=St.upgrades?.[t]|0,s=Math.max(0,Math.min(e.levels.length-1,i));return e.levels[s]}return Ao[n]??wo[n]}function fd(){const n=oe.tierThresholds;for(const t of Object.keys(St.gofiosByIsland)){const e=St.gofiosByIsland[t]|0;let i=0;for(let r=n.length-1;r>=0;r--)if(e>=n[r]){i=r;break}(St.oneShotTierByIsland[t]|0)>i&&(St.oneShotTierByIsland[t]=i)}}const Q={PEAK:"peak",CITY:"city",LANDSCAPE:"landscape",BEACH:"beach"};function Iu(n,t){const{center:e,metersPerUnit:i}=jt.heightmap,s=(t-e.lon)*111320*Math.cos(e.lat*Math.PI/180),r=(n-e.lat)*111320;return{x:s/i,z:-r/i}}const Sn=[{id:"tenerife",name:"Tenerife",lat:28.3,lon:-16.55,bboxRadius:1100,playable:!0},{id:"gomera",name:"La Gomera",lat:28.1,lon:-17.21,bboxRadius:350,playable:!0},{id:"palma",name:"La Palma",lat:28.71,lon:-17.85,bboxRadius:600,playable:!0},{id:"gc",name:"Gran Canaria",lat:27.93,lon:-15.59,bboxRadius:700,playable:!0},{id:"hierro",name:"El Hierro",lat:27.74,lon:-18.02,bboxRadius:350,playable:!0},{id:"fuerte",name:"Fuerteventura",lat:28.36,lon:-14.05,bboxRadius:1300,playable:!0},{id:"lanza",name:"Lanzarote",lat:29.04,lon:-13.62,bboxRadius:800,playable:!0},{id:"graciosa",name:"La Graciosa",lat:29.24,lon:-13.5,bboxRadius:180,playable:!0}].map(n=>({...n,...Iu(n.lat,n.lon)}));function pd(n){let t="tenerife",e=1/0;for(const i of Sn){if(!i.playable)continue;const s=n.x-i.x,r=n.z-i.z,o=s*s+r*r;o<e&&(e=o,t=i.id)}return t}const md=[{id:"tfe-peak-teide",island:"tenerife",type:Q.PEAK,name:"Pico del Teide",lat:28.2724,lon:-16.6425,ele:3715},{id:"tfe-peak-pico-viejo",island:"tenerife",type:Q.PEAK,name:"Pico Viejo",lat:28.2632,lon:-16.6534,ele:3135},{id:"tfe-peak-montana-blanca",island:"tenerife",type:Q.PEAK,name:"Montaña Blanca",lat:28.251,lon:-16.6035,ele:2748},{id:"tfe-peak-guajara",island:"tenerife",type:Q.PEAK,name:"Guajara",lat:28.2207,lon:-16.6157,ele:2718},{id:"tfe-peak-cinchado",island:"tenerife",type:Q.PEAK,name:"Roque Cinchado",lat:28.228,lon:-16.6172,ele:2167},{id:"tfe-peak-tigaiga",island:"tenerife",type:Q.PEAK,name:"Montaña de Tigaiga",lat:28.37,lon:-16.63,ele:1909},{id:"tfe-peak-conde",island:"tenerife",type:Q.PEAK,name:"Roque del Conde",lat:28.1093,lon:-16.7117,ele:1001},{id:"tfe-peak-cruz-carmen",island:"tenerife",type:Q.PEAK,name:"Cruz del Carmen",lat:28.5358,lon:-16.3025,ele:900},{id:"tfe-peak-roques-anaga",island:"tenerife",type:Q.PEAK,name:"Roques de Anaga",lat:28.5775,lon:-16.153,ele:227},{id:"tfe-city-santa-cruz",island:"tenerife",type:Q.CITY,name:"Santa Cruz de Tenerife",lat:28.4636,lon:-16.2518},{id:"tfe-city-la-laguna",island:"tenerife",type:Q.CITY,name:"San Cristóbal de La Laguna",lat:28.4853,lon:-16.3201},{id:"tfe-city-la-orotava",island:"tenerife",type:Q.CITY,name:"La Orotava",lat:28.3902,lon:-16.5234},{id:"tfe-city-puerto-cruz",island:"tenerife",type:Q.CITY,name:"Puerto de la Cruz",lat:28.4144,lon:-16.544},{id:"tfe-city-los-cristianos",island:"tenerife",type:Q.CITY,name:"Los Cristianos",lat:28.0507,lon:-16.71},{id:"tfe-city-las-americas",island:"tenerife",type:Q.CITY,name:"Playa de las Américas",lat:28.054,lon:-16.729},{id:"tfe-city-adeje",island:"tenerife",type:Q.CITY,name:"Adeje",lat:28.1226,lon:-16.7256},{id:"tfe-city-granadilla",island:"tenerife",type:Q.CITY,name:"Granadilla de Abona",lat:28.1182,lon:-16.5781},{id:"tfe-city-icod",island:"tenerife",type:Q.CITY,name:"Icod de los Vinos",lat:28.3729,lon:-16.7106},{id:"tfe-city-garachico",island:"tenerife",type:Q.CITY,name:"Garachico",lat:28.3735,lon:-16.7635},{id:"tfe-city-vilaflor",island:"tenerife",type:Q.CITY,name:"Vilaflor",lat:28.1572,lon:-16.6356},{id:"tfe-city-buenavista",island:"tenerife",type:Q.CITY,name:"Buenavista del Norte",lat:28.3712,lon:-16.8567},{id:"tfe-city-masca",island:"tenerife",type:Q.CITY,name:"Masca",lat:28.3001,lon:-16.8404},{id:"tfe-land-teide-park",island:"tenerife",type:Q.LANDSCAPE,name:"Parque Nacional del Teide",lat:28.2733,lon:-16.6422},{id:"tfe-land-anaga-park",island:"tenerife",type:Q.LANDSCAPE,name:"Parque Rural de Anaga",lat:28.55,lon:-16.2},{id:"tfe-land-teno-park",island:"tenerife",type:Q.LANDSCAPE,name:"Parque Rural de Teno",lat:28.35,lon:-16.85},{id:"tfe-land-barranco-infierno",island:"tenerife",type:Q.LANDSCAPE,name:"Barranco del Infierno",lat:28.1184,lon:-16.7245},{id:"tfe-land-barranco-masca",island:"tenerife",type:Q.LANDSCAPE,name:"Barranco de Masca",lat:28.3,lon:-16.841},{id:"tfe-land-cueva-viento",island:"tenerife",type:Q.LANDSCAPE,name:"Cueva del Viento",lat:28.3754,lon:-16.714},{id:"tfe-land-esperanza",island:"tenerife",type:Q.LANDSCAPE,name:"Bosque de la Esperanza",lat:28.48,lon:-16.41},{id:"tfe-land-pinar-chio",island:"tenerife",type:Q.LANDSCAPE,name:"Pinar de Chío",lat:28.27,lon:-16.71},{id:"tfe-land-los-gigantes",island:"tenerife",type:Q.LANDSCAPE,name:"Acantilados de Los Gigantes",lat:28.248,lon:-16.843},{id:"tfe-land-mirador-garachico",island:"tenerife",type:Q.LANDSCAPE,name:"Mirador de Garachico",lat:28.368,lon:-16.761},{id:"tfe-beach-teresitas",island:"tenerife",type:Q.BEACH,name:"Playa de las Teresitas",lat:28.5096,lon:-16.186},{id:"tfe-beach-vistas",island:"tenerife",type:Q.BEACH,name:"Playa de las Vistas",lat:28.0489,lon:-16.7218},{id:"tfe-beach-arena",island:"tenerife",type:Q.BEACH,name:"Playa de la Arena",lat:28.244,lon:-16.8053},{id:"tfe-beach-medano",island:"tenerife",type:Q.BEACH,name:"Playa El Médano",lat:28.0461,lon:-16.5343},{id:"tfe-beach-benijo",island:"tenerife",type:Q.BEACH,name:"Playa de Benijo",lat:28.5775,lon:-16.1838},{id:"tfe-beach-bollullo",island:"tenerife",type:Q.BEACH,name:"Playa del Bollullo",lat:28.4106,lon:-16.494},{id:"tfe-beach-fanabe",island:"tenerife",type:Q.BEACH,name:"Playa de Fañabé",lat:28.0907,lon:-16.7383},{id:"tfe-beach-jardin",island:"tenerife",type:Q.BEACH,name:"Playa Jardín",lat:28.4189,lon:-16.5586},{id:"tfe-beach-almaciga",island:"tenerife",type:Q.BEACH,name:"Playa de Almáciga",lat:28.5752,lon:-16.1714},{id:"tfe-beach-abama",island:"tenerife",type:Q.BEACH,name:"Playa de Abama",lat:28.1735,lon:-16.7937},{id:"gom-peak-garajonay",island:"gomera",type:Q.PEAK,name:"Alto de Garajonay",lat:28.1163,lon:-17.2476,ele:1487},{id:"gom-city-san-sebastian",island:"gomera",type:Q.CITY,name:"San Sebastián de La Gomera",lat:28.0911,lon:-17.1106},{id:"gom-city-valle-gran-rey",island:"gomera",type:Q.CITY,name:"Valle Gran Rey",lat:28.0922,lon:-17.3358},{id:"gom-city-vallehermoso",island:"gomera",type:Q.CITY,name:"Vallehermoso",lat:28.1797,lon:-17.2658},{id:"gom-city-hermigua",island:"gomera",type:Q.CITY,name:"Hermigua",lat:28.1656,lon:-17.1942},{id:"gom-land-garajonay-park",island:"gomera",type:Q.LANDSCAPE,name:"Parque Nacional de Garajonay",lat:28.1167,lon:-17.25},{id:"gom-land-los-organos",island:"gomera",type:Q.LANDSCAPE,name:"Los Órganos",lat:28.212,lon:-17.282},{id:"gom-land-roque-agando",island:"gomera",type:Q.LANDSCAPE,name:"Roque de Agando",lat:28.1153,lon:-17.2106},{id:"gom-beach-santiago",island:"gomera",type:Q.BEACH,name:"Playa de Santiago",lat:28.0294,lon:-17.1989},{id:"gom-beach-calera",island:"gomera",type:Q.BEACH,name:"Playa de la Calera",lat:28.1023,lon:-17.3401},{id:"gc-peak-nieves",island:"gc",type:Q.PEAK,name:"Pico de las Nieves",lat:27.9617,lon:-15.5803,ele:1949},{id:"gc-city-las-palmas",island:"gc",type:Q.CITY,name:"Las Palmas de Gran Canaria",lat:28.1235,lon:-15.4363},{id:"gc-city-maspalomas",island:"gc",type:Q.CITY,name:"Maspalomas",lat:27.7547,lon:-15.586},{id:"gc-city-teror",island:"gc",type:Q.CITY,name:"Teror",lat:28.0556,lon:-15.547},{id:"gc-city-telde",island:"gc",type:Q.CITY,name:"Telde",lat:27.9974,lon:-15.4178},{id:"gc-land-nublo",island:"gc",type:Q.LANDSCAPE,name:"Roque Nublo",lat:27.965,lon:-15.6175},{id:"gc-land-dunas",island:"gc",type:Q.LANDSCAPE,name:"Dunas de Maspalomas",lat:27.741,lon:-15.5797},{id:"gc-beach-canteras",island:"gc",type:Q.BEACH,name:"Playa de las Canteras",lat:28.1352,lon:-15.4348},{id:"gc-beach-ingles",island:"gc",type:Q.BEACH,name:"Playa del Inglés",lat:27.7597,lon:-15.58},{id:"gc-peak-tejeda",island:"gc",type:Q.PEAK,name:"Cruz de Tejeda",lat:28.0086,lon:-15.6075,ele:1490},{id:"gc-city-tafira",island:"gc",type:Q.CITY,name:"Tafira",lat:28.0769,lon:-15.4569},{id:"gc-city-san-mateo",island:"gc",type:Q.CITY,name:"San Mateo",lat:28.0205,lon:-15.5358},{id:"gc-city-mogan",island:"gc",type:Q.CITY,name:"Puerto de Mogán",lat:27.8158,lon:-15.7625},{id:"gc-land-bandama",island:"gc",type:Q.LANDSCAPE,name:"Caldera de Bandama",lat:28.0339,lon:-15.4519},{id:"gc-land-bentayga",island:"gc",type:Q.LANDSCAPE,name:"Roque Bentayga",lat:27.9697,lon:-15.6519},{id:"gc-land-andenes",island:"gc",type:Q.LANDSCAPE,name:"Andén Verde",lat:28.0769,lon:-15.7833},{id:"gc-beach-amadores",island:"gc",type:Q.BEACH,name:"Playa de Amadores",lat:27.7866,lon:-15.7264},{id:"gc-beach-tauro",island:"gc",type:Q.BEACH,name:"Playa de Tauro",lat:27.7831,lon:-15.7331},{id:"palma-peak-muchachos",island:"palma",type:Q.PEAK,name:"Roque de los Muchachos",lat:28.7544,lon:-17.8851,ele:2426},{id:"palma-city-santa-cruz",island:"palma",type:Q.CITY,name:"Santa Cruz de La Palma",lat:28.6835,lon:-17.7642},{id:"palma-city-llanos",island:"palma",type:Q.CITY,name:"Los Llanos de Aridane",lat:28.6585,lon:-17.9181},{id:"palma-land-taburiente",island:"palma",type:Q.LANDSCAPE,name:"Caldera de Taburiente",lat:28.708,lon:-17.872},{id:"palma-land-cumbre-vieja",island:"palma",type:Q.LANDSCAPE,name:"Cumbre Vieja",lat:28.574,lon:-17.8358},{id:"palma-beach-nogales",island:"palma",type:Q.BEACH,name:"Playa de Nogales",lat:28.7548,lon:-17.7616},{id:"palma-beach-puerto-naos",island:"palma",type:Q.BEACH,name:"Playa de Puerto Naos",lat:28.5828,lon:-17.9128},{id:"palma-peak-bejenado",island:"palma",type:Q.PEAK,name:"Pico Bejenado",lat:28.7036,lon:-17.8839,ele:1854},{id:"palma-peak-birigoyo",island:"palma",type:Q.PEAK,name:"Pico Birigoyo",lat:28.6483,lon:-17.8492,ele:1808},{id:"palma-city-tazacorte",island:"palma",type:Q.CITY,name:"Tazacorte",lat:28.6394,lon:-17.9333},{id:"palma-city-fuencaliente",island:"palma",type:Q.CITY,name:"Fuencaliente",lat:28.4889,lon:-17.8453},{id:"palma-city-mazo",island:"palma",type:Q.CITY,name:"Villa de Mazo",lat:28.6044,lon:-17.7892},{id:"palma-land-salinas",island:"palma",type:Q.LANDSCAPE,name:"Salinas de Fuencaliente",lat:28.4528,lon:-17.8447},{id:"palma-land-volcan-teneguia",island:"palma",type:Q.LANDSCAPE,name:"Volcán Teneguía",lat:28.4669,lon:-17.8425},{id:"palma-beach-charco-verde",island:"palma",type:Q.BEACH,name:"Playa de Charco Verde",lat:28.5483,lon:-17.8975},{id:"hierro-peak-malpaso",island:"hierro",type:Q.PEAK,name:"Pico de Malpaso",lat:27.733,lon:-18.0177,ele:1501},{id:"hierro-city-valverde",island:"hierro",type:Q.CITY,name:"Valverde",lat:27.8055,lon:-17.9183},{id:"hierro-city-frontera",island:"hierro",type:Q.CITY,name:"La Frontera",lat:27.7639,lon:-18.0122},{id:"hierro-land-sabinar",island:"hierro",type:Q.LANDSCAPE,name:"El Sabinar",lat:27.756,lon:-18.1148},{id:"hierro-land-bonanza",island:"hierro",type:Q.LANDSCAPE,name:"Roque de la Bonanza",lat:27.7029,lon:-17.9429},{id:"hierro-beach-charco-azul",island:"hierro",type:Q.BEACH,name:"Charco Azul",lat:27.8061,lon:-18.1057},{id:"hierro-city-tamaduste",island:"hierro",type:Q.CITY,name:"Tamaduste",lat:27.8125,lon:-17.9136},{id:"hierro-city-el-pinar",island:"hierro",type:Q.CITY,name:"El Pinar",lat:27.7053,lon:-17.9928},{id:"hierro-land-roques-salmor",island:"hierro",type:Q.LANDSCAPE,name:"Roques de Salmor",lat:27.8294,lon:-17.9694},{id:"hierro-land-pozo-salud",island:"hierro",type:Q.LANDSCAPE,name:"Pozo de la Salud",lat:27.7681,lon:-18.1219},{id:"hierro-land-punta-dehesa",island:"hierro",type:Q.LANDSCAPE,name:"Punta de la Dehesa",lat:27.7842,lon:-18.1633},{id:"hierro-beach-mar-calmas",island:"hierro",type:Q.BEACH,name:"Mar de las Calmas",lat:27.6961,lon:-18.0356},{id:"fuerte-peak-zarza",island:"fuerte",type:Q.PEAK,name:"Pico de la Zarza",lat:28.0828,lon:-14.3053,ele:807},{id:"fuerte-city-puerto-rosario",island:"fuerte",type:Q.CITY,name:"Puerto del Rosario",lat:28.5011,lon:-13.8627},{id:"fuerte-city-corralejo",island:"fuerte",type:Q.CITY,name:"Corralejo",lat:28.7361,lon:-13.87},{id:"fuerte-city-morro-jable",island:"fuerte",type:Q.CITY,name:"Morro Jable",lat:28.054,lon:-14.349},{id:"fuerte-land-corralejo-park",island:"fuerte",type:Q.LANDSCAPE,name:"Parque Natural de Corralejo",lat:28.717,lon:-13.834},{id:"fuerte-land-calderon",island:"fuerte",type:Q.LANDSCAPE,name:"Calderón Hondo",lat:28.703,lon:-13.939},{id:"fuerte-beach-sotavento",island:"fuerte",type:Q.BEACH,name:"Playa de Sotavento",lat:28.1973,lon:-14.218},{id:"fuerte-beach-cofete",island:"fuerte",type:Q.BEACH,name:"Playa de Cofete",lat:28.0945,lon:-14.382},{id:"fuerte-city-betancuria",island:"fuerte",type:Q.CITY,name:"Betancuria",lat:28.4244,lon:-14.0589},{id:"fuerte-city-antigua",island:"fuerte",type:Q.CITY,name:"Antigua",lat:28.4181,lon:-14.0114},{id:"fuerte-city-pajara",island:"fuerte",type:Q.CITY,name:"Pájara",lat:28.3531,lon:-14.1006},{id:"fuerte-city-caleta-fuste",island:"fuerte",type:Q.CITY,name:"Caleta de Fuste",lat:28.395,lon:-13.8633},{id:"fuerte-city-tuineje",island:"fuerte",type:Q.CITY,name:"Tuineje",lat:28.3219,lon:-14.0481},{id:"fuerte-land-isla-lobos",island:"fuerte",type:Q.LANDSCAPE,name:"Isla de Lobos",lat:28.7556,lon:-13.8225},{id:"fuerte-land-arena-volcano",island:"fuerte",type:Q.LANDSCAPE,name:"Volcán de la Arena",lat:28.6997,lon:-13.9594},{id:"fuerte-beach-garcey",island:"fuerte",type:Q.BEACH,name:"Playa de Garcey",lat:28.3344,lon:-14.2197},{id:"lanza-peak-penas-chache",island:"lanza",type:Q.PEAK,name:"Peñas del Chache",lat:29.1108,lon:-13.5468,ele:671},{id:"lanza-city-arrecife",island:"lanza",type:Q.CITY,name:"Arrecife",lat:28.9637,lon:-13.5477},{id:"lanza-city-costa-teguise",island:"lanza",type:Q.CITY,name:"Costa Teguise",lat:28.987,lon:-13.5},{id:"lanza-city-playa-blanca",island:"lanza",type:Q.CITY,name:"Playa Blanca",lat:28.8597,lon:-13.8253},{id:"lanza-land-timanfaya",island:"lanza",type:Q.LANDSCAPE,name:"Parque Nacional de Timanfaya",lat:29,lon:-13.755},{id:"lanza-land-cueva-verdes",island:"lanza",type:Q.LANDSCAPE,name:"Cueva de los Verdes",lat:29.1574,lon:-13.4342},{id:"lanza-land-mirador-rio",island:"lanza",type:Q.LANDSCAPE,name:"Mirador del Río",lat:29.2179,lon:-13.4827},{id:"lanza-beach-papagayo",island:"lanza",type:Q.BEACH,name:"Playa Papagayo",lat:28.835,lon:-13.804},{id:"lanza-beach-famara",island:"lanza",type:Q.BEACH,name:"Playa de Famara",lat:29.13,lon:-13.5538},{id:"lanza-peak-montana-roja",island:"lanza",type:Q.PEAK,name:"Montaña Roja",lat:28.8567,lon:-13.8636,ele:194},{id:"lanza-city-teguise",island:"lanza",type:Q.CITY,name:"Teguise",lat:29.0589,lon:-13.5614},{id:"lanza-city-haria",island:"lanza",type:Q.CITY,name:"Haría",lat:29.1453,lon:-13.4972},{id:"lanza-city-yaiza",island:"lanza",type:Q.CITY,name:"Yaiza",lat:28.9528,lon:-13.7686},{id:"lanza-city-tinajo",island:"lanza",type:Q.CITY,name:"Tinajo",lat:29.0628,lon:-13.675},{id:"lanza-land-jameos",island:"lanza",type:Q.LANDSCAPE,name:"Jameos del Agua",lat:29.1583,lon:-13.4344},{id:"lanza-land-el-golfo",island:"lanza",type:Q.LANDSCAPE,name:"El Golfo",lat:28.9722,lon:-13.8261},{id:"lanza-beach-quemada",island:"lanza",type:Q.BEACH,name:"Playa Quemada",lat:28.9039,lon:-13.7572},{id:"graciosa-peak-agujas",island:"graciosa",type:Q.PEAK,name:"Las Agujas Grandes",lat:29.262,lon:-13.502,ele:266},{id:"graciosa-city-caleta",island:"graciosa",type:Q.CITY,name:"Caleta del Sebo",lat:29.2261,lon:-13.5021},{id:"graciosa-land-amarilla",island:"graciosa",type:Q.LANDSCAPE,name:"Montaña Amarilla",lat:29.2128,lon:-13.539},{id:"graciosa-beach-conchas",island:"graciosa",type:Q.BEACH,name:"Playa de las Conchas",lat:29.27,lon:-13.541},{id:"graciosa-beach-francesa",island:"graciosa",type:Q.BEACH,name:"Playa Francesa",lat:29.215,lon:-13.531},{id:"graciosa-city-pedro-barba",island:"graciosa",type:Q.CITY,name:"Pedro Barba",lat:29.2461,lon:-13.4778},{id:"graciosa-peak-bermeja",island:"graciosa",type:Q.PEAK,name:"Montaña Bermeja",lat:29.2603,lon:-13.5183,ele:157},{id:"graciosa-beach-lambra",island:"graciosa",type:Q.BEACH,name:"Playa Lambra",lat:29.2725,lon:-13.505}],yi=md.map(n=>({...n,...Iu(n.lat,n.lon)}));(function(){const t=2*oe.ring.majorRadius+1.2,e=t*t,i=30;for(let s=0;s<i;s++){let r=!1;for(let o=0;o<yi.length;o++)for(let a=o+1;a<yi.length;a++){const l=yi[o],c=yi[a],u=l.x-c.x,h=l.z-c.z,f=u*u+h*h;if(f>=e)continue;if(f<1e-4){l.x+=.13,l.z+=.07,c.x-=.13,c.z-=.07,r=!0;continue}const m=Math.sqrt(f),x=(t-m)*.5,v=u/m,p=h/m;l.x+=v*x,l.z+=p*x,c.x-=v*x,c.z-=p*x,r=!0}if(!r)break}})();const gd=yi.reduce((n,t)=>((n[t.island]??=[]).push(t),n),{}),Du="teide-save",Ir=2,Nu=["punkte","gofiosByIsland","obsidian","landings","bestFlightPunkte","upgrades","oneShotTierByIsland","exploredPOIs","checkpointRunwayId","currentIsland","testMode"];function _d(){const n={version:Ir};for(const t of Nu)n[t]=St[t];return n}function xd(n){for(const t of Nu){const e=n[t];if(e===void 0)continue;const i=St[t];i&&typeof i=="object"&&!Array.isArray(i)&&e&&typeof e=="object"&&!Array.isArray(e)?Object.assign(i,e):St[t]=e}}function vd(n){if(n.version===1){const t={};if(n.exploredPOIs)for(const e of yi){if(!n.exploredPOIs[e.id])continue;const i=oe.rewardsByType[e.type];i&&(t[e.island]=(t[e.island]|0)+i.gofios)}n.gofiosByIsland=t,n.version=2}return n}function yd(){try{const n=localStorage.getItem(Du);if(!n)return!1;let t=JSON.parse(n);return!t||typeof t!="object"?!1:typeof t.version!="number"?(console.warn("[save] discarding save: missing version"),!1):t.version>Ir?(console.warn(`[save] discarding save: future version ${t.version} > ${Ir}`),!1):(t=vd(t),t.version!==Ir?(console.warn(`[save] discarding save: migration left version at ${t.version}`),!1):(xd(t),!0))}catch(n){return console.warn("[save] load failed:",n),!1}}function Md(){try{localStorage.setItem(Du,JSON.stringify(_d()))}catch(n){console.warn("[save] write failed:",n)}}let ga=!1;function ri(){ga||(ga=!0,queueMicrotask(()=>{ga=!1,Md()}))}const me={up:!1,down:!1,left:!1,right:!1,brake:!1,boost:!1,oneShot:!1};function Uu(n,t){switch(n.key){case"ArrowUp":case"w":case"W":me.up=t;break;case"ArrowDown":case"s":case"S":me.down=t;break;case"ArrowLeft":case"a":case"A":me.left=t;break;case"ArrowRight":case"d":case"D":me.right=t;break;case" ":case"Spacebar":me.brake=t&&hd(),n.preventDefault();break;case"Shift":me.boost=t;break;case"f":case"F":me.oneShot=t;break;case"t":case"T":t&&(St.testMode=!St.testMode,qs(),ri());break;case"b":case"B":if(t&&St.testMode){const e=Pe.oneShot.tiers.length-1,i=G.boosterOverride!=null?G.boosterOverride:4;G.boosterOverride=(i+1)%(e+1)}break}}window.addEventListener("keydown",n=>Uu(n,!0));window.addEventListener("keyup",n=>Uu(n,!1));const Fu="teide-settings",Ou=100,Ro=3e3,Bu=1e4,Po=1e7,Lo={low:{segments:800,samples:15e5},standard:{segments:1200,samples:25e5},high:{segments:2e3,samples:5e6},ultra:{segments:Ro,samples:Po}},_a={...Lo.standard};function zu(){try{const n=localStorage.getItem(Fu);if(!n)return{..._a};const t=JSON.parse(n);return ku({..._a,...t})}catch{return{..._a}}}function Sd(n){try{localStorage.setItem(Fu,JSON.stringify(ku(n)))}catch{}}function ku(n){return{segments:Math.max(Ou,Math.min(Ro,n.segments|0)),samples:Math.max(Bu,Math.min(Po,n.samples|0))}}function Ed(){const n=zu(),t=new URLSearchParams(window.location.search),e=parseInt(t.get("segments"),10),i=parseInt(t.get("samples"),10);return Number.isFinite(e)&&e>=Ou&&e<=Ro&&(n.segments=e),Number.isFinite(i)&&i>=Bu&&i<=Po&&(n.samples=i),jt.segments=n.segments,Re.sampleCount=n.samples,n}function bd(n){for(const[t,e]of Object.entries(Lo))if(e.segments===n.segments&&e.samples===n.samples)return t;return null}const Io={garage:document.getElementById("garage-overlay"),shop:document.getElementById("shop-overlay"),settings:document.getElementById("settings-overlay")},al=document.getElementById("garage-punkte"),ol=document.getElementById("garage-highscore"),ll=document.getElementById("garage-obsidian"),cl=document.getElementById("garage-island"),ul=document.getElementById("garage-booster"),vs=document.getElementById("garage-stats"),Ps=document.getElementById("garage-upgrades"),hl=document.getElementById("shop-obsidian"),$n=document.getElementById("obsidian-confirm"),dl=document.getElementById("obsidian-confirm-text"),Td=document.getElementById("obsidian-confirm-cancel"),Ad=document.getElementById("obsidian-confirm-ok"),os=document.getElementById("settings-segments"),ls=document.getElementById("settings-samples"),wd=document.getElementById("settings-apply"),Cd=document.getElementById("settings-cancel"),Gu=document.querySelectorAll(".settings-preset");let Ls=null,zr=null;function Hu(n){return Pe.oneShot.tiers[n]?.name||`Level ${n}`}function Rd(n){return n.charAt(0).toUpperCase()+n.slice(1)}function Jn(n){return Math.round(n).toLocaleString("de-DE")}function Pd(n){Cs();const t=Io[n];t&&(n==="garage"&&ea(),n==="shop"&&Gd(),n==="settings"&&Hd(),t.classList.add("visible"),t.setAttribute("aria-hidden","false"),Ls=n)}function Cs(){if(!Ls)return;const n=Io[Ls];n&&(n.classList.remove("visible"),n.setAttribute("aria-hidden","true")),Ls=null}function ea(){Ld(),Nd(),Ud()}function Ld(){al&&(al.textContent=Jn(St.punkte)),ol&&(ol.textContent=Jn(St.bestFlightPunkte|0)),ll&&(ll.textContent=Jn(St.obsidian|0)),cl&&(cl.textContent=Rd(St.currentIsland)),ul&&(ul.textContent=Hu(wi(St.currentIsland)))}const Id=[{key:"maxSpeed",label:"Spitzentempo",src:"plane",invert:!1},{key:"drag",label:"Aerodynamik",src:"plane",invert:!0},{key:"speedFromPitch",label:"Sturzflug",src:"plane",invert:!1},{key:"stallSpeed",label:"Stabilität",src:"plane",invert:!0},{key:"takeoffSpeed",label:"Startgeschwindigkeit",src:"takeoff",invert:!1}];function Dd(n){const t=dd(n.key),e=n.src==="plane"?Jr[n.key]:Qr[n.key],i=n.src==="plane"?Ao[n.key]:wo[n.key],s=n.invert?e-t:t-e,r=n.invert?e-i:i-e;return Math.abs(r)<1e-6?{pct:100,cur:t,full:i}:{pct:Math.max(0,Math.min(100,s/r*100)),cur:t,full:i}}function Nd(){if(!vs)return;vs.innerHTML="";for(const o of Id){const{pct:a,cur:l,full:c}=Dd(o),u=document.createElement("div");u.className="stat-row",u.innerHTML=`
  ...
  `,vs.appendChild(t);const e=wi(St.currentIsland),i=Pe.oneShot.tiers.length-1,s=e/i*100,r=document.createElement("div");r.className="stat-row",r.innerHTML=`
    <div class="stat-row-head">
      <span>Booster</span>
      <span class="stat-row-pct">${Hu(e)}</span>
    </div>
    <div class="stat-row-bar"><div class="stat-row-bar-fill" style="width: ${s}%"></div></div>
  `,vs.appendChild(r)}function Ud(){if(Ps){Ps.innerHTML="";for(const[n,t]of Object.entries(Pi)){const e=St.upgrades[n]|0,i=t.levels.length-1,s=e>=i,r=s?0:t.costs[e+1],o=r>0?Math.ceil(r/Co.obsidianPerPunkte):0;let a,l,c;s?(a="Max",l=!0,c=""):St.punkte>=r?(a=`Kaufen · ${Jn(r)} P`,l=!1,c="punkte"):(St.obsidian|0)>=o?(a=`Mit Obsidian · ${o} O`,l=!1,c="obsidian"):(a=`Kaufen · ${Jn(r)} P`,l=!0,c="");const u=document.createElement("div");u.className="upgrade-row";const h=St.testMode&&e>0?`<button class="upgrade-sell" type="button" data-sell="${n}">Verkaufen · ${Jn(t.costs[e])} P</button>`:"";u.innerHTML=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function mc(){return new si({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Go(),fragmentShader:`
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function gc(){return new si({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Go(),fragmentShader:`
...
void main() {
    ...
    `});return $r=new px(r,o),n.add($r),n}function $v(n){if(!$r)return;const t=$r.geometry.attributes.position,e=t.array,i=Je.columnTop,s=Je.riseSpeed;for(let r=0;r<qn.length;r++){const o=cn[bo[r]];qn[r]+=s*o.strength/i*n,qn[r]>=1&&(qn[r]-=1);const a=o.radius*(jr+(Gh-jr)*qn[r]);e[r*3+0]=o.x+Ur[r]*a,e[r*3+1]=o.baseElevation+qn[r]*i,e[r*3+2]=o.z+Fr[r]*a}t.needsUpdate=!0}function Zv(n,t,e){let i=0;for(const s of cn){const r=n-s.x,o=e-s.z,a=Math.sqrt(r*r+o*o);if(a>=s.radius)continue;const l=t-(s.baseElevation??0);if(l<0)continue;const c=1-a/s.radius,u=Math.max(0,1-l/Je.maxAltitude);i+=Je.liftAtCenter*s.strength*c*u}return i}const Kv=ye;class Zr extends $o{constructor(t){super(t),this.defaultDPI=90,this.defaultUnit="px"}load(t,e,i,s){const r=this,o=new Kx(r.manager);o.setPath(r.path),o.setRequestHeader(r.requestHeader),o.setWithCredentials(r.withCredentials),o.load(t,function(a){try{e(r.parse(a))}catch(l){s?s(l):console.error(l),r.manager.itemError(t)}},i,s)}parse(t){const e=this;function i(N,I){if(N.nodeType!==1)return;const R=S(N);let T=!1,K=null;switch(N.nodeName){case"svg":I=x(N,I);break;case"style":r(N);break;case"g":I=x(N,I);break;case"path":I=x(N,I),N.hasAttribute("d")&&(K=s(N));break;case"rect":I=x(N,I),K=l(N);break;case"polygon":I=x(N,I),K=c(N);break;case"polyline":I=x(N,I),K=u(N);break;case"circle":I=x(N,I),K=h(N);break;case"ellipse":I=x(N,I),K=f(N);break;case"line":I=x(N,I),K=m(N);break;case"defs":T=!0;break;case"use":I=x(N,I);const ct=(N.getAttributeNS("http://www.w3.org/1999/xlink","href")||"").substring(1),P=N.viewportElement.getElementById(ct);P?i(P,I):console.warn("SVGLoader: 'use node' references non-existent node id: "+ct);break}K&&(I.fill!==void 0&&I.fill!=="none"&&K.color.setStyle(I.fill,Kv),A(K,pt),W.push(K),K.userData={node:N,style:I});const lt=N.childNodes;for(let X=0;X<lt.length;X++){const ct=lt[X];T&&ct.nodeName!=="style"&&ct.nodeName!=="defs"||i(ct,I)}R&&(F.pop(),F.length>0?pt.copy(F[F.length-1]):pt.identity())}function s(N){const I=new fi,R=new dt,T=new dt,K=new dt;let lt=!0,X=!1;const ct=N.getAttribute("d");if(ct===""||ct==="none")return null;const P=ct.match(/[a-df-z][^a-df-z]*/ig);for(let tt=0,B=P.length;tt<B;tt++){const Y=P[tt],q=Y.charAt(0),ht=Y.slice(1).trim();lt===!0&&(X=!0,lt=!1);let U;switch(q){case"M":U=p(ht);for(let g=0,M=U.length;g<M;g+=2)R.x=U[g+0],R.y=U[g+1],T.x=R.x,T.y=R.y,g===0?I.moveTo(R.x,R.y):I.lineTo(R.x,R.y),g===0&&K.copy(R);break;case"H":U=p(ht);for(let g=0,M=U.length;g<M;g++)R.x=U[g],T.x=R.x,T.y=R.y,I.lineTo(R.x,R.y),g===0&&X===!0&&K.copy(R);break;case"V":U=p(ht);for(let g=0,M=U.length;g<M;g++)R.y=U[g],T.x=R.x,T.y=R.y,I.lineTo(R.x,R.y),g===0&&X===!0&&K.copy(R);break;case"L":U=p(ht);for(let g=0,M=U.length;g<M;g+=2)R.x=U[g+0],R.y=U[g+1],T.x=R.x,T.y=R.y,I.lineTo(R.x,R.y),g===0&&X===!0&&K.copy(R);break;case"C":U=p(ht);for(let g=0,M=U.length;g<M;g+=6)I.bezierCurveTo(U[g+0],U[g+1],U[g+2],U[g+3],U[g+4],U[g+5]),T.x=U[g+2],T.y=U[g+3],R.x=U[g+4],R.y=U[g+5],g===0&&X===!0&&K.copy(R);break;case"S":U=p(ht);for(let g=0,M=U.length;g<M;g+=4)I.bezierCurveTo(v(R.x,T.x),v(R.y,T.y),U[g+0],U[g+1],U[g+2],U[g+3]),T.x=U[g+0],T.y=U[g+1],R.x=U[g+2],R.y=U[g+3],g===0&&X===!0&&K.copy(R);break;case"Q":U=p(ht);for(let g=0,M=U.length;g<M;g+=4)I.quadraticCurveTo(U[g+0],U[g+1],U[g+2],U[g+3]),T.x=U[g+0],T.y=U[g+1],R.x=U[g+2],R.y=U[g+3],g===0&&X===!0&&K.copy(R);break;case"T":U=p(ht);for(let g=0,M=U.length;g<M;g+=2){const k=v(R.x,T.x),ft=v(R.y,T.y);I.quadraticCurveTo(k,ft,U[g+0],U[g+1]),T.x=k,T.y=ft,R.x=U[g+0],R.y=U[g+1],g===0&&X===!0&&K.copy(R)}break;case"A":U=p(ht,[3,4],7);for(let g=0,M=U.length;g<M;g+=7){if(U[g+5]==R.x&&U[g+6]==R.y)continue;const k=R.clone();R.x=U[g+5],R.y=U[g+6],T.x=R.x,T.y=R.y,o(I,U[g],U[g+1],U[g+2],U[g+3],U[g+4],k,R),g===0&&X===!0&&K.copy(R)}break;case"m":U=p(ht);for(let g=0,M=U.length;g<M;g+=2)R.x+=U[g+0],R.y+=U[g+1],T.x=R.x,T.y=R.y,g===0?I.moveTo(R.x,R.y):I.lineTo(R.x,R.y),g===0&&K.copy(R);break;case"h":U=p(ht);for(let g=0,M=U.length;g<M;g++)R.x+=U[g],T.x=R.x,T.y=R.y,I.lineTo(R.x,R.y),g===0&&X===!0&&K.copy(R);break;case"v":U=p(ht);for(let g=0,M=U.length;g<M;g++)R.y+=U[g],T.x=R.x,T.y=R.y,I.lineTo(R.x,R.y),g===0&&X===!0&&K.copy(R);break;case"l":U=p(ht);for(let g=0,M=U.length;g<M;g+=2)R.x+=U[g+0],R.y+=U[g+1],T.x=R.x,T.y=R.y,I.lineTo(R.x,R.y),g===0&&X===!0&&K.copy(R);break;case"c":U=p(ht);for(let g=0,M=U.length;g<M;g+=6)I.bezierCurveTo(R.x+U[g+0],R.y+U[g+1],R.x+U[g+2],R.y+U[g+3],R.x+U[g+4],R.y+U[g+5]),T.x=R.x+U[g+2],T.y=R.y+U[g+3],R.x+=U[g+4],R.y+=U[g+5],g===0&&X===!0&&K.copy(R);break;case"s":U=p(ht);for(let g=0,M=U.length;g<M;g+=4)I.bezierCurveTo(v(R.x,T.x),v(R.y,T.y),R.x+U[g+0],R.y+U[g+1],R.x+U[g+2],R.y+U[g+3]),T.x=R.x+U[g+0],T.y=R.y+U[g+1],R.x+=U[g+2],R.y+=U[g+3],g===0&&X===!0&&K.copy(R);break;case"q":U=p(ht);for(let g=0,M=U.length;g<M;g+=4)I.quadraticCurveTo(R.x+U[g+0],R.y+U[g+1],R.x+U[g+2],R.y+U[g+3]),T.x=R.x+U[g+0],T.y=R.y+U[g+1],R.x+=U[g+2],R.y+=U[g+3],g===0&&X===!0&&K.copy(R);break;case"t":U=p(ht);for(let g=0,M=U.length;g<M;g+=2){const k=v(R.x,T.x),ft=v(R.y,T.y);I.quadraticCurveTo(k,ft,R.x+U[g+0],R.y+U[g+1]),T.x=k,T.y=ft,R.x=R.x+U[g+0],R.y=R.y+U[g+1],g===0&&X===!0&&K.copy(R)}break;case"a":U=p(ht,[3,4],7);for(let g=0,M=U.length;g<M;g+=7){if(U[g+5]==0&&U[g+6]==0)continue;const k=R.clone();R.x+=U[g+5],R.y+=U[g+6],T.x=R.x,T.y=R.y,o(I,U[g],U[g+1],U[g+2],U[g+3],U[g+4],k,R),g===0&&X===!0&&K.copy(R)}break;case"Z":case"z":I.currentPath.autoClose=!0,I.currentPath.curves.length>0&&(R.copy(K),I.currentPath.currentPoint.copy(R),lt=!0);break;default:console.warn(Y)}X=!1}return I}function r(N){if(!(!N.sheet||!N.sheet.cssRules||!N.sheet.cssRules.length))for(let I=0;I<N.sheet.cssRules.length;I++){const R=N.sheet.cssRules[I];if(R.type!==1)continue;const T=R.selectorText.split(/,/gm).filter(Boolean).map(K=>K.trim());for(let K=0;K<T.length;K++){const lt=Object.fromEntries(Object.entries(R.style).filter(([,X])=>X!==""));ut[T[K]]=Object.assign(ut[T[K]]||{},lt)}}}function o(N,I,R,T,K,lt,X,ct){if(I==0||R==0){N.lineTo(ct.x,ct.y);return}T=T*Math.PI/180,I=Math.abs(I),R=Math.abs(R);const P=(X.x-ct.x)/2,tt=(X.y-ct.y)/2,B=Math.cos(T)*P+Math.sin(T)*tt,Y=-Math.sin(T)*P+Math.cos(T)*tt;let q=I*I,ht=R*R;const U=B*B,g=Y*Y,M=U/q+g/ht;if(M>1){const gt=Math.sqrt(M);I=gt*I,R=gt*R,q=I*I,ht=R*R}const k=q*g+ht*U,ft=(q*ht-k)/k;let mt=Math.sqrt(Math.max(0,ft));K===lt&&(mt=-mt);const ot=mt*I*Y/R,Tt=-mt*R*B/I,vt=Math.cos(T)*ot-Math.sin(T)*Tt+(X.x+ct.x)/2,At=Math.sin(T)*ot+Math.cos(T)*Tt+(X.y+ct.y)/2,Lt=a(1,0,(B-ot)/I,(Y-Tt)/R),Ft=a((B-ot)/I,(Y-Tt)/R,(-B-ot)/I,(-Y-Tt)/R)%(Math.PI*2);N.currentPath.absellipse(vt,At,I,R,Lt,Lt+Ft,lt===0,T)}function a(N,I,R,T){const K=N*R+I*T,lt=Math.sqrt(N*N+I*I)*Math.sqrt(R*R+T*T);let X=Math.acos(Math.max(-1,Math.min(1,K/lt)));return N*T-I*R<0&&(X=-X),X}function l(N){const I=_(N.getAttribute("x")||0),R=_(N.getAttribute("y")||0),T=_(N.getAttribute("rx")||N.getAttribute("ry")||0),K=_(N.getAttribute("ry")||N.getAttribute("rx")||0),lt=_(N.getAttribute("width")),X=_(N.getAttribute("height")),ct=1-.551915024494,P=new fi;return P.moveTo(I+T,R),P.lineTo(I+lt-T,R),(T!==0||K!==0)&&P.bezierCurveTo(I+lt-T*ct,R,I+lt,R+K*ct,I+lt,R+K),P.lineTo(I+lt,R+X-K),(T!==0||K!==0)&&P.bezierCurveTo(I+lt,R+X-K*ct,I+lt-T*ct,R+X,I+lt-T,R+X),P.lineTo(I+T,R+X),(T!==0||K!==0)&&P.bezierCurveTo(I+T*ct,R+X,I,R+X-K*ct,I,R+X-K),P.lineTo(I,R+K),(T!==0||K!==0)&&P.bezierCurveTo(I,R+K*ct,I+T*ct,R,I+T,R),P}function c(N){function I(lt,X,ct){const P=_(X),tt=_(ct);K===0?T.moveTo(P,tt):T.lineTo(P,tt),K++}const R=/([+-]?\d*\.?\d+(?:e[+-]?\d+)?)(?:,|\s)([+-]?\d*\.?\d+(?:e[+-]?\d+)?)/g,T=new fi;let K=0;return N.getAttribute("points").replace(R,I),T.currentPath.autoClose=!0,T}function u(N){function I(lt,X,ct){const P=_(X),tt=_(ct);K===0?T.moveTo(P,tt):T.lineTo(P,tt),K++}const R=/([+-]?\d*\.?\d+(?:e[+-]?\d+)?)(?:,|\s)([+-]?\d*\.?\d+(?:e[+-]?\d+)?)/g,T=new fi;let K=0;return N.getAttribute("points").replace(R,I),T.currentPath.autoClose=!1,T}function h(N){const I=_(N.getAttribute("cx")||0),R=_(N.getAttribute("cy")||0),T=_(N.getAttribute("r")||0),K=new as;K.absarc(I,R,T,0,Math.PI*2);const lt=new fi;return lt.subPaths.push(K),lt}function f(N){const I=_(N.getAttribute("cx")||0),R=_(N.getAttribute("cy")||0),T=_(N.getAttribute("rx")||0),K=_(N.getAttribute("ry")||0),lt=new as;lt.absellipse(I,R,T,K,0,Math.PI*2);const X=new fi;return X.subPaths.push(lt),X}function m(N){const I=_(N.getAttribute("x1")||0),R=_(N.getAttribute("y1")||0),T=_(N.getAttribute("x2")||0),K=_(N.getAttribute("y2")||0),lt=new fi;return lt.moveTo(I,R),lt.lineTo(T,K),lt.currentPath.autoClose=!1,lt}function x(N,I){I=Object.assign({},I);let R={};if(N.hasAttribute("class")){const X=N.getAttribute("class").split(/\s/).filter(Boolean).map(ct=>ct.trim());for(let ct=0;ct<X.length;ct++)R=Object.assign(R,ut["."+X[ct]])}N.hasAttribute("id")&&(R=Object.assign(R,ut["#"+N.getAttribute("id")]));function T(X,ct,P){P===void 0&&(P=function(B){return B.startsWith("url")&&console.warn("SVGLoader: url access in attributes is not implemented."),B}),N.hasAttribute(X)&&(I[ct]=P(N.getAttribute(X))),R[X]&&(I[ct]=P(R[X])),N.style&&N.style[X]!==""&&(I[ct]=P(N.style[X]))}function K(X){return Math.max(0,Math.min(1,_(X)))}function lt(X){return Math.max(0,_(X))}return T("fill","fill"),T("fill-opacity","fillOpacity",K),T("fill-rule","fillRule"),T("opacity","opacity",K),T("stroke","stroke"),T("stroke-opacity","strokeOpacity",K),T("stroke-width","strokeWidth",lt),T("stroke-linejoin","strokeLineJoin"),T("stroke-linecap","strokeLineCap"),T("stroke-miterlimit","strokeMiterLimit",lt),T("visibility","visibility"),I}function v(N,I){return N-(I-N)}function p(N,I,R){if(typeof N!="string")throw new TypeError("Invalid input: "+typeof N);const T={WHITESPACE:/[ \t\r\n]/,DIGIT:/[\d]/,SIGN:/[-+]/,POINT:/\./,COMMA:/,/,EXP:/e/i,FLAGS:/[01]/},K=0,lt=1,X=2,ct=3;let P=K,tt=!0,B="",Y="";const q=[];function ht(k,ft,mt){const ot=new SyntaxError('Unexpected character "'+k+'" at index '+ft+".");throw ot.partial=mt,ot}function U(){B!==""&&(Y===""?q.push(Number(B)):q.push(Number(B)*Math.pow(10,Number(Y)))),B="",Y=""}let g;const M=N.length;for(let k=0;k<M;k++){if(g=N[k],Array.isArray(I)&&I.includes(q.length%R)&&T.FLAGS.test(g)){P=lt,B=g,U();continue}if(P===K){if(T.WHITESPACE.test(g))continue;if(T.DIGIT.test(g)||T.SIGN.test(g)){P=lt,B=g;continue}if(T.POINT.test(g)){P=X,B=g;continue}T.COMMA.test(g)&&(tt&&ht(g,k,q),tt=!0)}if(P===lt){if(T.DIGIT.test(g)){B+=g;continue}if(T.POINT.test(g)){B+=g,P=X;continue}if(T.EXP.test(g)){P=ct;continue}T.SIGN.test(g)&&B.length===1&&T.SIGN.test(B[0])&&ht(g,k,q)}if(P===X){if(T.DIGIT.test(g)){B+=g;continue}if(T.EXP.test(g)){P=ct;continue}T.POINT.test(g)&&B[B.length-1]==="."&&ht(g,k,q)}if(P===ct){if(T.DIGIT.test(g)){Y+=g;continue}if(T.SIGN.test(g)){if(Y===""){Y+=g;continue}Y.length===1&&T.SIGN.test(Y)&&ht(g,k,q)}}T.WHITESPACE.test(g)?(U(),P=K,tt=!1):T.COMMA.test(g)?(U(),P=K,tt=!0):T.SIGN.test(g)?(U(),P=lt,B=g):T.POINT.test(g)?(U(),P=X,B=g):ht(g,k,q)}return U(),q}const d=["mm","cm","in","pt","pc","px"],y={mm:{mm:1,cm:.1,in:1/25.4,pt:72/25.4,pc:6/25.4,px:-1},cm:{mm:10,cm:1,in:1/2.54,pt:72/2.54,pc:6/2.54,px:-1},in:{mm:25.4,cm:2.54,in:1,pt:72,pc:6,px:-1},pt:{mm:25.4/72,cm:2.54/72,in:1/72,pt:1,pc:6/72,px:-1},pc:{mm:25.4/6,cm:2.54/6,in:1/6,pt:72/6,pc:1,px:-1},px:{px:1}};function _(N){let I="px";if(typeof N=="string"||N instanceof String)for(let T=0,K=d.length;T<K;T++){const lt=d[T];if(N.endsWith(lt)){I=lt,N=N.substring(0,N.length-lt.length);break}}let R;return I==="px"&&e.defaultUnit!=="px"?R=y.in[e.defaultUnit]/e.defaultDPI:(R=y[I][e.defaultUnit],R<0&&(R=y[I].in*e.defaultDPI)),R*parseFloat(N)}function S(N){if(!(N.hasAttribute("transform")||N.nodeName==="use"&&(N.hasAttribute("x")||N.hasAttribute("y"))))return null;const I=L(N);return F.length>0&&I.premultiply(F[F.length-1]),pt.copy(I),F.push(I),I}function L(N){const I=new zt,R=j;if(N.nodeName==="use"&&(N.hasAttribute("x")||N.hasAttribute("y"))){const T=_(N.getAttribute("x")),K=_(N.getAttribute("y"));I.translate(T,K)}if(N.hasAttribute("transform")){const T=N.getAttribute("transform").split(")");for(let K=T.length-1;K>=0;K--){const lt=T[K].trim();if(lt==="")continue;const X=lt.indexOf("("),ct=lt.length;if(X>0&&X<ct){const P=lt.slice(0,X),tt=p(lt.slice(X+1));switch(R.identity(),P){case"translate":if(tt.length>=1){const B=tt[0];let Y=0;tt.length>=2&&(Y=tt[1]),R.translate(B,Y)}break;case"rotate":if(tt.length>=1){let B=0,Y=0,q=0;B=tt[0]*Math.PI/180,tt.length>=3&&(Y=tt[1],q=tt[2]),Z.makeTranslation(-Y,-q),J.makeRotation(B),H.multiplyMatrices(J,Z),Z.makeTranslation(Y,q),R.multiplyMatrices(Z,H)}break;case"scale":if(tt.length>=1){const B=tt[0];let Y=B;tt.length>=2&&(Y=tt[1]),R.scale(B,Y)}break;case"skewX":tt.length===1&&R.set(1,Math.tan(tt[0]*Math.PI/180),0,0,1,0,0,0,1);break;case"skewY":tt.length===1&&R.set(1,0,0,Math.tan(tt[0]*Math.PI/180),1,0,0,0,1);break;case"matrix":tt.length===6&&R.set(tt[0],tt[2],tt[4],tt[1],tt[3],tt[5],0,0,1);break}}I.premultiply(R)}}return I}function A(N,I){function R(X){at.set(X.x,X.y,1).applyMatrix3(I),X.set(at.x,at.y)}function T(X){const ct=X.xRadius,P=X.yRadius,tt=Math.cos(X.aRotation),B=Math.sin(X.aRotation),Y=new D(ct*tt,ct*B,0),q=new D(-P*B,P*tt,0),ht=Y.applyMatrix3(I),U=q.applyMatrix3(I),g=j.set(ht.x,U.x,0,ht.y,U.y,0,0,0,1),M=Z.copy(g).invert(),mt=J.copy(M).transpose().multiply(M).elements,ot=V(mt[0],mt[1],mt[4]),Tt=Math.sqrt(ot.rt1),vt=Math.sqrt(ot.rt2);if(X.xRadius=1/Tt,X.yRadius=1/vt,X.aRotation=Math.atan2(ot.sn,ot.cs),!((X.aEndAngle-X.aStartAngle)%(2*Math.PI)<Number.EPSILON)){const Lt=Z.set(Tt,0,0,0,vt,0,0,0,1),Ft=J.set(ot.cs,ot.sn,0,-ot.sn,ot.cs,0,0,0,1),gt=Lt.multiply(Ft).multiply(g),$t=Ht=>{const{x:Ot,y:It}=new D(Math.cos(Ht),Math.sin(Ht),0).applyMatrix3(gt);return Math.atan2(It,Ot)};X.aStartAngle=$t(X.aStartAngle),X.aEndAngle=$t(X.aEndAngle),w(I)&&(X.aClockwise=!X.aClockwise)}}function K(X){const ct=E(I),P=b(I);X.xRadius*=ct,X.yRadius*=P;const tt=ct>Number.EPSILON?Math.atan2(I.elements[1],I.elements[0]):Math.atan2(-I.elements[3],I.elements[4]);X.aRotation+=tt,w(I)&&(X.aStartAngle*=-1,X.aEndAngle*=-1,X.aClockwise=!X.aClockwise)}const lt=N.subPaths;for(let X=0,ct=lt.length;X<ct;X++){const tt=lt[X].curves;for(let B=0;B<tt.length;B++){const Y=tt[B];Y.isLineCurve?(R(Y.v1),R(Y.v2)):Y.isCubicBezierCurve?(R(Y.v0),R(Y.v1),R(Y.v2),R(Y.v3)):Y.isQuadraticBezierCurve?(R(Y.v0),R(Y.v1),R(Y.v2)):Y.isEllipseCurve&&(st.set(Y.aX,Y.aY),R(st),Y.aX=st.x,Y.aY=st.y,O(I)?T(Y):K(Y))}}}function w(N){const I=N.elements;return I[0]*I[4]-I[1]*I[3]<0}function O(N){const I=N.elements,R=I[0]*I[3]+I[1]*I[4];if(R===0)return!1;const T=E(N),K=b(N);return Math.abs(R/(T*K))>Number.EPSILON}function E(N){const I=N.elements;return Math.sqrt(I[0]*I[0]+I[1]*I[1])}function b(N){const I=N.elements;return Math.sqrt(I[3]*I[3]+I[4]*I[4])}function V(N,I,R){let T,K,lt,X,ct;const P=N+R,tt=N-R,B=Math.sqrt(tt*tt+4*I*I);return P>0?(T=.5*(P+B),ct=1/T,K=N*ct*R-I*ct*I):P<0?K=.5*(P-B):(T=.5*B,K=-.5*B),tt>0?lt=tt+B:lt=tt-B,Math.abs(lt)>2*Math.abs(I)?(ct=-2*I/lt,X=1/Math.sqrt(1+ct*ct),lt=ct*X):Math.abs(I)===0?(lt=1,X=0):(ct=-.5*lt/I,lt=1/Math.sqrt(1+ct*ct),X=ct*lt),tt>0&&(ct=lt,lt=-X,X=ct),{rt1:T,rt2:K,cs:lt,sn:X}}const W=[],ut={},F=[],j=new zt,Z=new zt,J=new zt,H=new zt,st=new dt,at=new D,pt=new zt,xt=new DOMParser().parseFromString(t,"image/svg+xml");return i(xt.documentElement,{fill:"#000",fillOpacity:1,strokeOpacity:1,strokeWidth:1,strokeLineJoin:"miter",strokeLineCap:"butt",strokeMiterLimit:4}),{paths:W,xml:xt.documentElement}}static createShapes(t){const i={ORIGIN:0,DESTINATION:1,BETWEEN:2,LEFT:3,RIGHT:4,BEHIND:5,BEYOND:6},s={loc:i.ORIGIN,t:0};function r(v,p,d,y){const _=v.x,S=p.x,L=d.x,A=y.x,w=v.y,O=p.y,E=d.y,b=y.y,V=(A-L)*(w-E)-(b-E)*(_-L),W=(S-_)*(w-E)-(O-w)*(_-L),ut=(b-E)*(S-_)-(A-L)*(O-w),F=V/ut,j=W/ut;if(ut===0&&V!==0||F<=0||F>=1||j<0||j>1)return null;if(V===0&&ut===0){for(let Z=0;Z<2;Z++)if(o(Z===0?d:y,v,p),s.loc==i.ORIGIN){const J=Z===0?d:y;return{x:J.x,y:J.y,t:s.t}}else if(s.loc==i.BETWEEN){const J=+(_+s.t*(S-_)).toPrecision(10),H=+(w+s.t*(O-w)).toPrecision(10);return{x:J,y:H,t:s.t}}return null}else{for(let H=0;H<2;H++)if(o(H===0?d:y,v,p),s.loc==i.ORIGIN){const st=H===0?d:y;return{x:st.x,y:st.y,t:s.t}}const Z=+(_+F*(S-_)).toPrecision(10),J=+(w+F*(O-w)).toPrecision(10);return{x:Z,y:J,t:F}}}function o(v,p,d){const y=d.x-p.x,_=d.y-p.y,S=v.x-p.x,L=v.y-p.y,A=y*L-S*_;if(v.x===p.x&&v.y===p.y){s.loc=i.ORIGIN,s.t=0;return}if(v.x===d.x&&v.y===d.y){s.loc=i.DESTINATION,s.t=1;return}if(A<-Number.EPSILON){s.loc=i.LEFT;return}if(A>Number.EPSILON){s.loc=i.RIGHT;return}if(y*S<0||_*L<0){s.loc=i.BEHIND;return}if(Math.sqrt(y*y+_*_)<Math.sqrt(S*S+L*L)){s.loc=i.BEYOND;return}let w;y!==0?w=S/y:w=L/_,s.loc=i.BETWEEN,s.t=w}function a(v,p){const d=[],y=[];for(let _=1;_<v.length;_++){const S=v[_-1],L=v[_];for(let A=1;A<p.length;A++){const w=p[A-1],O=p[A],E=r(S,L,w,O);E!==null&&d.find(b=>b.t<=E.t+Number.EPSILON&&b.t>=E.t-Number.EPSILON)===void 0&&(d.push(E),y.push(new dt(E.x,E.y)))}}return y}function l(v,p,d){const y=new dt;p.getCenter(y);const _=[];return d.forEach(S=>{S.boundingBox.containsPoint(y)&&a(v,S.points).forEach(A=>{_.push({identifier:S.identifier,isCW:S.isCW,point:A})})}),_.sort((S,L)=>S.point.x-L.point.x),_}function c(v,p,d,y,_){(_==null||_==="")&&(_="nonzero");const S=new dt;v.boundingBox.getCenter(S);const L=[new dt(d,S.y),new dt(y,S.y)],A=l(L,v.boundingBox,p);A.sort((W,ut)=>W.point.x-ut.point.x);const w=[],O=[];A.forEach(W=>{W.identifier===v.identifier?w.push(W):O.push(W)});const E=w[0].point.x,b=[];let V=0;for(;V<O.length&&O[V].point.x<E;)b.length>0&&b[b.length-1]===O[V].identifier?b.pop():b.push(O[V].identifier),V++;if(b.push(v.identifier),_==="evenodd"){const W=b.length%2===0,ut=b[b.length-2];return{identifier:v.identifier,isHole:W,for:ut}}else if(_==="nonzero"){let W=!0,ut=null,F=null;for(let j=0;j<b.length;j++){const Z=b[j];W?(F=p[Z].isCW,W=!1,ut=Z):F!==p[Z].isCW&&(F=p[Z].isCW,W=!0)}return{identifier:v.identifier,isHole:W,for:ut}}else console.warn('fill-rule: "'+_+'" is currently not implemented.')}let u=999999999,h=-999999999,f=t.subPaths.map(v=>{const p=v.getPoints();let d=-999999999,y=999999999,_=-999999999,S=999999999;for(let L=0;L<p.length;L++){const A=p[L];A.y>d&&(d=A.y),A.y<y&&(y=A.y),A.x>_&&(_=A.x),A.x<S&&(S=A.x)}return h<=_&&(h=_+1),u>=S&&(u=S-1),{curves:v.curves,points:p,isCW:En.isClockWise(p),identifier:-1,boundingBox:new nv(new dt(S,y),new dt(_,d))}});f=f.filter(v=>v.points.length>1);for(let v=0;v<f.length;v++)f[v].identifier=v;const m=f.map(v=>c(v,f,u,h,t.userData?t.userData.style.fillRule:void 0)),x=[];return f.forEach(v=>{if(!m[v.identifier].isHole){const d=new Ti;d.curves=v.curves,m.filter(_=>_.isHole&&_.for===v.identifier).forEach(_=>{const S=f[_.identifier],L=new as;L.curves=S.curves,d.holes.push(L)}),x.push(d)}}),x}static getStrokeStyle(t,e,i,s,r){return t=t!==void 0?t:1,e=e!==void 0?e:"#000",i=i!==void 0?i:"miter",s=s!==void 0?s:"butt",r=r!==void 0?r:4,{strokeColor:e,strokeWidth:t,strokeLineJoin:i,strokeLineCap:s,strokeMiterLimit:r}}static pointsToStroke(t,e,i,s){const r=[],o=[],a=[];if(Zr.pointsToStrokeWithBuffers(t,e,i,s,r,o,a)===0)return null;const l=new _e;return l.setAttribute("position",new Kt(r,3)),l.setAttribute("normal",new Kt(o,3)),l.setAttribute("uv",new Kt(a,2)),l}static pointsToStrokeWithBuffers(t,e,i,s,r,o,a,l){const c=new dt,u=new dt,h=new dt,f=new dt,m=new dt,x=new dt,v=new dt,p=new dt,d=new dt,y=new dt,_=new dt,S=new dt,L=new dt,A=new dt,w=new dt,O=new dt,E=new dt;i=i!==void 0?i:12,s=s!==void 0?s:.001,l=l!==void 0?l:0,t=tt(t);const b=t.length;if(b<2)return 0;const V=t[0].equals(t[b-1]);let W,ut=t[0],F;const j=e.strokeWidth/2,Z=1/(b-1);let J=0,H,st,at,pt,xt=!1,rt=0,N=l*3,I=l*2;R(t[0],t[1],c).multiplyScalar(j),p.copy(t[0]).sub(c),d.copy(t[0]).add(c),y.copy(p),_.copy(d);for(let B=1;B<b;B++){W=t[B],B===b-1?V?F=t[1]:F=void 0:F=t[B+1];const Y=c;if(R(ut,W,Y),h.copy(Y).multiplyScalar(j),S.copy(W).sub(h),L.copy(W).add(h),H=J+Z,st=!1,F!==void 0){R(W,F,u),h.copy(u).multiplyScalar(j),A.copy(W).sub(h),w.copy(W).add(h),at=!0,h.subVectors(F,ut),Y.dot(h)<0&&(at=!1),B===1&&(xt=at),h.subVectors(F,W),h.normalize();const q=Math.abs(Y.dot(h));if(q>Number.EPSILON){const ht=j/q;h.multiplyScalar(-ht),f.subVectors(W,ut),m.copy(f).setLength(ht).add(h),O.copy(m).negate();const U=m.length(),g=f.length();f.divideScalar(g),x.subVectors(F,W);const M=x.length();switch(x.divideScalar(M),f.dot(O)<g&&x.dot(O)<M&&(st=!0),E.copy(m).add(W),O.add(W),pt=!1,st?at?(w.copy(O),L.copy(O)):(A.copy(O),S.copy(O)):lt(),e.strokeLineJoin){case"bevel":X(at,st,H);break;case"round":ct(at,st),at?K(W,S,A,H,0):K(W,w,L,H,1);break;case"miter":case"miter-clip":default:const k=j*e.strokeMiterLimit/U;if(k<1)if(e.strokeLineJoin!=="miter-clip"){X(at,st,H);break}else ct(at,st),at?(x.subVectors(E,S).multiplyScalar(k).add(S),v.subVectors(E,A).multiplyScalar(k).add(A),T(S,H,0),T(x,H,0),T(W,H,.5),T(W,H,.5),T(x,H,0),T(v,H,0),T(W,H,.5),T(v,H,0),T(A,H,0)):(x.subVectors(E,L).multiplyScalar(k).add(L),v.subVectors(E,w).multiplyScalar(k).add(w),T(L,H,1),T(x,H,1),T(W,H,.5),T(W,H,.5),T(x,H,1),T(v,H,1),T(W,H,.5),T(v,H,1),T(w,H,1));else st?(at?(T(d,J,1),T(p,J,0),T(E,H,0),T(d,J,1),T(E,H,0),T(O,H,1)):(T(d,J,1),T(p,J,0),T(E,H,1),T(p,J,0),T(O,H,0),T(E,H,1)),at?A.copy(E):w.copy(E)):at?(T(S,H,0),T(E,H,0),T(W,H,.5),T(W,H,.5),T(E,H,0),T(A,H,0)):(T(L,H,1),T(E,H,1),T(W,H,.5),T(W,H,.5),T(E,H,1),T(w,H,1)),pt=!0;break}}else lt()}else lt();!V&&B===b-1&&P(t[0],y,_,at,!0,J),J=H,ut=W,p.copy(A),d.copy(w)}if(!V)P(W,S,L,at,!1,H);else if(st&&r){let B=E,Y=O;xt!==at&&(B=O,Y=E),at?(pt||xt)&&(Y.toArray(r,0*3),Y.toArray(r,3*3),pt&&B.toArray(r,1*3)):(pt||!xt)&&(Y.toArray(r,1*3),Y.toArray(r,3*3),pt&&B.toArray(r,0*3))}return rt;function R(B,Y,q){return q.subVectors(Y,B),q.set(-q.y,q.x).normalize()}function T(B,Y,q){r&&(r[N]=B.x,r[N+1]=B.y,r[N+2]=0,o&&(o[N]=0,o[N+1]=0,o[N+2]=1),N+=3,a&&(a[I]=Y,a[I+1]=q,I+=2)),rt+=3}function K(B,Y,q,ht,U){c.copy(Y).sub(B).normalize(),u.copy(q).sub(B).normalize();let g=Math.PI;const M=c.dot(u);Math.abs(M)<1&&(g=Math.abs(Math.acos(M))),g/=i,h.copy(Y);for(let k=0,ft=i-1;k<ft;k++)f.copy(h).rotateAround(B,g),T(h,ht,U),T(f,ht,U),T(B,ht,.5),h.copy(f);T(f,ht,U),T(q,ht,U),T(B,ht,.5)}function lt(){T(d,J,1),T(p,J,0),T(S,H,0),T(d,J,1),T(S,H,1),T(L,H,0)}function X(B,Y,q){Y?B?(T(d,J,1),T(p,J,0),T(S,H,0),T(d,J,1),T(S,H,0),T(O,H,1),T(S,q,0),T(A,q,0),T(O,q,.5)):(T(d,J,1),T(p,J,0),T(L,H,1),T(p,J,0),T(O,H,0),T(L,H,1),T(L,q,1),T(O,q,0),T(w,q,1)):B?(T(S,q,0),T(A,q,0),T(W,q,.5)):(T(L,q,1),T(w,q,0),T(W,q,.5))}function ct(B,Y){Y&&(B?(T(d,J,1),T(p,J,0),T(S,H,0),T(d,J,1),T(S,H,0),T(O,H,1),T(S,J,0),T(W,H,.5),T(O,H,1),T(W,H,.5),T(A,J,0),T(O,H,1)):(T(d,J,1),T(p,J,0),T(L,H,1),T(p,J,0),T(O,H,0),T(L,H,1),T(L,J,1),T(O,H,0),T(W,H,.5),T(W,H,.5),T(O,H,0),T(w,J,1)))}function P(B,Y,q,ht,U,g){switch(e.strokeLineCap){case"round":U?K(B,q,Y,g,.5):K(B,Y,q,g,.5);break;case"square":if(U)c.subVectors(Y,B),u.set(c.y,-c.x),h.addVectors(c,u).add(B),f.subVectors(u,c).add(B),ht?(h.toArray(r,1*3),f.toArray(r,0*3),f.toArray(r,3*3)):(h.toArray(r,1*3),h.toArray(r,3*3),f.toArray(r,0*3));else{c.subVectors(q,B),u.set(c.y,-c.x),h.addVectors(c,u).add(B),f.subVectors(u,c).add(B);const M=r.length;ht?(h.toArray(r,M-1*3),f.toArray(r,M-2*3),f.toArray(r,M-4*3)):(f.toArray(r,M-2*3),h.toArray(r,M-1*3),f.toArray(r,M-4*3))}break}}function tt(B){let Y=!1;for(let ht=1,U=B.length-1;ht<U;ht++)if(B[ht].distanceTo(B[ht+1])<s){Y=!0;break}if(!Y)return B;const q=[];q.push(B[0]);for(let ht=1,U=B.length-1;ht<U;ht++)B[ht].distanceTo(B[ht+1])>=s&&q.push(B[ht]);return q.push(B[B.length-1]),q}}}const Jv=document.getElementById("pts"),Qv=document.getElementById("lnd"),ty=document.getElementById("alt"),ey=document.getElementById("spd"),ny=document.getElementById("hdg"),iy=document.getElementById("lift-row"),To=document.getElementById("landing-toast"),sy=document.getElementById("controls-hint"),Qa=document.getElementById("boost-grey-fill"),to=document.getElementById("boost-oneshot-tile"),su=document.getElementById("test-mode-border"),Cr=document.getElementById("poi-toast"),Fs=document.getElementById("poi-label"),ru=document.getElementById("tp-island"),ry={peak:document.querySelector('[data-tp="peak-count"]'),city:document.querySelector('[data-tp="city-count"]'),landscape:document.querySelector('[data-tp="landscape-count"]'),beach:document.querySelector('[data-tp="beach-count"]')},au=document.getElementById("tp-tier-current"),ou=document.getElementById("tp-tier-progress"),lu=document.getElementById("tp-gofios-total");let cu="";const uu=["No Booster","Booster Level 1","Booster Level 2","Booster Level 3","Booster Level MAX"],hu=["","Booster Level 1 freigeschalten","Booster Level 2 freigeschalten — La Gomera in Reichweite","Booster Level 3 freigeschalten — Gran Canaria in Reichweite","Booster Level MAX freigeschalten — Fuerteventura / Lanzarote"];let Rr=null,Kr=null,du=-1,eo=null,fu=null;const ay="↑ ↓ Pitch · ← → Bank · Space Brake · Shift Boost · F One-Shot",oy="↓ / S to launch",ly="Takeoff roll…";let pu=null;const no=new D;function ws(n,t){return Math.max(0,Math.round(n)).toString().padStart(t,"0")}function cy(n){To.innerHTML=`Geschafft! · ${n.id}<span class="bonus">+ ${Ai.landingBonus} pts</span>`,To.classList.add("show")}function Hh(){To.classList.remove("show")}function mu(n,t,e,i){if(!Cr)return;const s=e>0?`+ ${t} P · + ${e} G`:`+ ${t} P`,r=i&&hu[i]?`<span class="tier-up">${hu[i]}</span>`:"";Cr.innerHTML=`${n}<span class="reward">${s}</span>${r}`,Cr.classList.add("show"),Rr&&clearTimeout(Rr),Rr=setTimeout(()=>{Cr.classList.remove("show"),Rr=null},oe.activationToast.duration*1e3)}function uy(n){Fs&&n!==Kr&&(Fs.textContent=n,Fs.classList.add("show"),Kr=n)}function hy(){Fs&&Kr!==null&&(Fs.classList.remove("show"),Kr=null)}function dy(){const n=kn(_t.position.x,_t.position.z);Jv.textContent=ws(St.punkte,5),Qv.textContent=ws(St.landings,2),ty.textContent=ws(_t.position.y-Math.max(n,jt.waterLevel),3),ey.textContent=ws(G.speed,3),no.set(0,0,-1).applyQuaternion(_t.quaternion);const t=(Math.atan2(no.x,-no.z)*180/Math.PI+360)%360;ny.textContent=ws(t,3),iy.style.opacity=G.inThermal?"0.85":"0";const e=G.flightState===ne.INTRO?"":G.flightState===ne.PRELAUNCH?oy:G.flightState===ne.TAKEOFF_ROLL?ly:ay;e!==pu&&(sy.textContent=e,pu=e),fy(),py(),my()}function fy(){if(Qa&&(Qa.style.width=(G.boostFuelGrey*100).toFixed(1)+"%",Qa.style.opacity=G.greyActive?"1":"0.7"),!to)return;const n=wi(),t=Pe.oneShot.tiers[n]||Pe.oneShot.tiers[0],e=n>0&&G.boostFuelOneshot>.001;n!==du&&(to.style.background="#"+t.color.toString(16).padStart(6,"0"),du=n,eo=null),e!==eo&&(to.classList.toggle("spent",!e),eo=e)}function py(){su&&St.testMode!==fu&&(su.classList.toggle("visible",!!St.testMode),fu=St.testMode)}function my(){const n=St.currentIsland,t=gd[n]||[],e={peak:0,city:0,landscape:0,beach:0},i={peak:0,city:0,landscape:0,beach:0};for(const u of t)e[u.type]++,St.exploredPOIs[u.id]&&i[u.type]++;const s=St.gofiosByIsland[n]|0,r=wi(n),o=oe.tierThresholds,a=r+1<o.length?r+1:null,l=a!==null?Math.max(0,o[a]-s):0,c=`${n}|${r}|${s}|${i.peak}/${e.peak}|${i.city}/${e.city}|${i.landscape}/${e.landscape}|${i.beach}/${e.beach}`;if(c!==cu){cu=c,ru&&(ru.textContent=n.charAt(0).toUpperCase()+n.slice(1));for(const u of["peak","city","landscape","beach"]){const h=ry[u];h&&(h.textContent=`${i[u]}/${e[u]}`)}au&&(au.textContent=uu[r]||`Level ${r}`),lu&&(lu.textContent=`${s} G`),ou&&(ou.textContent=a!==null?`→ ${uu[a]} in ${l} G`:"— max erreicht")}}const gy={[Q.PEAK]:'<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M480-390Zm-132-53 55 37 77-39 77 39 53-35-40-79H386l-38 77ZM209-160h541L646-369l-83 55-83-41-83 41-85-56-103 210ZM80-80l234-475q10-20 29.5-32.5T386-600h54v-280h280l-40 80 40 80H520v120h50q23 0 42 12t30 32L880-80H80Z"/></svg>',[Q.CITY]:'<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M120-120v-560h240v-80l120-120 120 120v240h240v400H120Zm80-80h80v-80h-80v80Zm0-160h80v-80h-80v80Zm0-160h80v-80h-80v80Zm240 320h80v-80h-80v80Zm0-160h80v-80h-80v80Zm0-160h80v-80h-80v80Zm0-160h80v-80h-80v80Zm240 480h80v-80h-80v80Zm0-160h80v-80h-80v80Z"/></svg>',[Q.LANDSCAPE]:'<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="m40-240 240-320 180 240h300L560-586 460-454l-50-66 150-200 360 480H40Zm521-80Zm-361 0h160l-80-107-80 107Zm0 0h160-160Z"/></svg>',[Q.BEACH]:'<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M784-120 530-374l56-56 254 254-56 56Zm-546-28q-60-60-89-135t-29-153q0-78 29-152t89-134q60-60 134.5-89.5T525-841q78 0 152.5 29.5T812-722L238-148Zm8-122 54-54q-16-21-30.5-43T243-411q-12-22-21-44t-16-43q-11 59-1.5 118T246-270Zm112-110 222-224q-43-33-86.5-53.5t-81.5-28q-38-7.5-68.5-2.5T296-666q-17 18-22 48.5t2.5 69q7.5 38.5 28 81.5t53.5 87Zm278-280 56-54q-53-32-112-42t-118 2q22 7 44 16t44 20.5q22 11.5 43.5 26T636-660Z"/></svg>'},Vh=[];function _y(){return new jo(oe.ring.majorRadius,oe.ring.tubeRadius,10,48)}const Wh={};function xy(){const n=new Zr,t=oe.symbol.size/960,e=oe.symbol.extrudeDepth/t;for(const[i,s]of Object.entries(gy)){const r=n.parse(s),o=[];for(const l of r.paths)o.push(...Zr.createShapes(l));const a=new qo(o,{depth:e,bevelEnabled:!1});a.scale(1,-1,1),a.center(),a.scale(t,t,t),Wh[i]=a}}function vy(){xy();const n=_y(),t=new de;for(const e of yi){const i=oe.colorsByType[e.type],s=new Fn({color:i.ring,transparent:!0,opacity:oe.ring.opacity,depthWrite:!1}),r=new te(n,s),o=new ge({color:i.symbol,transparent:!0,opacity:.95,flatShading:!0,side:Ge}),a=new te(Wh[e.type],o),l=new de;l.add(r),l.add(a);const c=kn(e.x,e.z);l.position.set(e.x,c+oe.ring.hoverHeight,e.z),t.add(l),Vh.push({poi:e,ring:r,ringMat:s,symbol:a,symbolMat:o,poiGroup:l,wasInsideZone:!1,frozen:!1})}return t}function yy(n,t){const e=t.x-n.x,i=t.y-n.y,s=t.z-n.z;return e*e+i*i+s*s<=oe.activation.radius*oe.activation.radius}function My(n){const t=St.gofiosByIsland[n]|0,e=oe.tierThresholds;let i=0;for(let r=e.length-1;r>=0;r--)if(t>=e[r]){i=r;break}const s=St.oneShotTierByIsland[n]|0;return i>s?(St.oneShotTierByIsland[n]=i,i):0}function Sy(n){const t=oe.rewardsByType[n.type];if(St.testMode){mu(n.name,t.punkte,t.gofios,0);return}const e=!!St.exploredPOIs[n.id];ta(t.punkte);let i=0,s=0;e||(St.exploredPOIs[n.id]=!0,St.gofiosByIsland[n.island]=(St.gofiosByIsland[n.island]|0)+t.gofios,i=t.gofios,s=My(n.island)),mu(n.name,t.punkte,i,s),ri()}function Ey(n){const t=!St.testMode&&!!St.exploredPOIs[n.poi.id];if(t)n.ringMat.opacity=oe.ring.opacityActivated,n.ringMat.color.setHex(oe.ring.colorActivated),n.symbolMat.opacity=.55,n.symbolMat.color.setHex(oe.symbol.colorActivated);else{const e=oe.colorsByType[n.poi.type];n.ringMat.opacity=oe.ring.opacity,n.ringMat.color.setHex(e.ring),n.symbolMat.opacity=.95,n.symbolMat.color.setHex(e.symbol)}n.frozen=t}function by(n,t){const e=t.position,i=pd(e);i!==St.currentIsland&&(St.currentIsland=i,ri());let s=null,r=oe.hoverLabelRadius*oe.hoverLabelRadius;for(const o of Vh){Ey(o);const a=e.x-o.poiGroup.position.x,l=e.z-o.poiGroup.position.z;o.poiGroup.rotation.y=Math.atan2(a,l),o.frozen||(o.symbol.rotation.y+=oe.symbol.rotRate*n);const c=yy(o.poiGroup.position,e);if(c&&!o.wasInsideZone&&Sy(o.poi),o.wasInsideZone=c,St.exploredPOIs[o.poi.id]){const u=e.x-o.poi.x,h=e.z-o.poi.z,f=u*u+h*h;f<r&&(r=f,s=o.poi)}}s?uy(s.name):hy()}const Xh=document.getElementById("island-compass"),gu=Xh?.querySelector(".compass-track"),_u=Math.PI/2,Ty=12,qh=new Map,io=new D;function Ay(){if(gu)for(const n of Sn){const t=document.createElement("div");t.className="compass-marker"+(n.playable?"":" unreachable"),t.dataset.island=n.id,t.innerHTML=`
      <span class="compass-name">${n.name}</span>
      <span class="compass-dist"></span>
    `,gu.appendChild(t),qh.set(n.id,{el:t,dist:t.querySelector(".compass-dist"),lastLeft:null,lastDist:null,lastHidden:null})}}function wy(n){return io.set(0,0,-1).applyQuaternion(n.quaternion),Math.atan2(io.x,-io.z)}function Cy(n){for(;n>Math.PI;)n-=2*Math.PI;for(;n<=-Math.PI;)n+=2*Math.PI;return n}const Ji=[];function Ry(n){if(!Xh)return;const t=wy(n),e=jt.heightmap.metersPerUnit;Ji.length=0;for(const s of Sn){const r=qh.get(s.id);if(!r)continue;const o=s.x-n.position.x,a=s.z-n.position.z,c=Math.sqrt(o*o+a*a)*e/1e3,u=Math.atan2(o,-a),h=Cy(u-t);if(Math.abs(h)>_u||c<.5){Ji.push({m:r,distKm:c,pct:0,show:!1});continue}const f=(h/_u*.5+.5)*100;Ji.push({m:r,distKm:c,pct:f,show:!0})}Ji.sort((s,r)=>s.distKm-r.distKm);const i=[];for(const s of Ji){if(!s.show)continue;let r=!1;for(const o of i)if(Math.abs(o-s.pct)<Ty){r=!0;break}if(r){s.show=!1;continue}i.push(s.pct)}for(const s of Ji){const r=s.m,o=!s.show;if(o!==r.lastHidden&&(r.el.classList.toggle("hidden",o),r.lastHidden=o),o)continue;const a=s.pct.toFixed(1)+"%";a!==r.lastLeft&&(r.el.style.left=a,r.lastLeft=a);const l=s.distKm<10?s.distKm.toFixed(1)+" km":Math.round(s.distKm)+" km";l!==r.lastDist&&(r.dist.textContent=l,r.lastDist=l)}}const Yh=[];(function(){for(const t of[-.95,.95]){const e=new Float32Array(Yn.verts*3),i=new Float32Array(Yn.verts*3);for(let a=0;a<Yn.verts;a++){const l=a/(Yn.verts-1);e[a*3]=t,e[a*3+1]=-.05,e[a*3+2]=.42+l*Yn.maxLen;const c=1-l;i[a*3]=c,i[a*3+1]=c,i[a*3+2]=c}const s=new _e;s.setAttribute("position",new Le(e,3)),s.setAttribute("color",new Le(i,3));const r=new ra({vertexColors:!0,transparent:!0,opacity:0,blending:kr,depthWrite:!1}),o=new Mh(s,r);_t.add(o),Yh.push(o)}})();function Py(){const n=pe.stallSpeed+3,t=pe.maxSpeed*.7,e=Gs.clamp((G.speed-n)/(t-n),0,1),i=Yn.maxLen*(.3+e*.7);for(const s of Yh){const r=s.geometry.attributes.position.array;for(let o=0;o<Yn.verts;o++){const a=o/(Yn.verts-1);r[o*3+2]=.42+a*i}s.geometry.attributes.position.needsUpdate=!0,s.material.opacity=e*.95}}const xu=new de,Ko=[];(function(){const i=Math.atan2(.28,.95),s=new ge({color:Jt.paper,side:Ge,flatShading:!0}),r=new ra({color:Jt.ink,transparent:!0,opacity:.32});for(const o of[-.45,.45]){const a=new de;a.position.set(o,.045,.05),a.rotation.z=o<0?i:-i;const l=new Ni(.32,.22);l.translate(0,-.22/2,0),l.rotateX(-Math.PI/2);const c=new te(l,s),u=new wh(l);c.add(new Sh(u,r)),a.add(c),xu.add(a),Ko.push(c)}_t.add(xu)})();function Ly(n){const t=me.brake&&G.alive&&G.flightState===ne.FLYING?1:0,e=1-Math.exp(-n/ro.deployTau);G.brakeAmount+=(t-G.brakeAmount)*e;const i=-G.brakeAmount*ro.maxAngle;for(const s of Ko)s.rotation.x=i}function Iy(){G.brakeAmount=0;for(const n of Ko)n.rotation.x=0}const Mn=new de;(function(){const t=new ge({color:Jt.ink,flatShading:!0});function e(i,s,r,o){const a=new de,l=new Bn(.018,.018,r,6);l.translate(0,-r/2,0),a.add(new te(l,t));const c=new Bn(o,o,.04,12);return c.rotateZ(Math.PI/2),c.translate(0,-r,0),a.add(new te(c,t)),a.position.set(i,-.05,s),a}Mn.add(e(0,-.55,.11,.055)),Mn.add(e(-.42,.12,.12,.06)),Mn.add(e(.42,.12,.12,.06)),Mn.scale.setScalar(.001),Mn.visible=!1,_t.add(Mn)})();function Dy(n){const t=uv(_t.position,ma.triggerDist,ma.triggerHeight)?1:0,e=1-Math.exp(-n/ma.deployTau);G.gearAmount+=(t-G.gearAmount)*e;const i=Math.max(.001,G.gearAmount);Mn.scale.setScalar(i),Mn.visible=G.gearAmount>.02}function Ny(){G.gearAmount=1,Mn.scale.setScalar(1),Mn.visible=!0}const vu=new de,Jo=[],yu=new Rt;let Rs=0;(function(){const t=Pe.exhaust;for(const e of[-.36,t.offsetX]){const i=new Bn(t.radiusNarrow,t.radiusWide,1,12,1,!0);i.rotateX(-Math.PI/2),i.translate(0,0,.5);const s=new Fn({color:16777215,transparent:!0,opacity:0,blending:kr,depthWrite:!1,side:Ge}),r=new te(i,s);r.position.set(e,t.offsetY,t.offsetZ),r.scale.z=0,vu.add(r),Jo.push(r)}_t.add(vu)})();function Uy(){return G.oneShotActive?(Pe.oneShot.tiers[wi()]||Pe.oneShot.tiers[0]).color:G.greyActive?Pe.grey.color:null}function Fy(n){const t=Pe.exhaust,e=G.oneShotActive||G.greyActive?1:0,i=1-Math.exp(-n/Math.max(t.intensityTau,1e-4));Rs+=(e-Rs)*i;const s=Uy();s!==null&&yu.setHex(s);for(const r of Jo)r.scale.z=t.length*Rs,r.material.opacity=.85*Rs,s!==null&&r.material.color.copy(yu)}function Oy(){Rs=0;for(const n of Jo)n.scale.z=0,n.material.opacity=0}const By=.9,jh=.55,zy=35,ky=1.6,$h=new aa(By,28);$h.rotateX(-Math.PI/2);const Zh=new Fn({color:0,transparent:!0,opacity:jh,depthWrite:!1}),vi=new te($h,Zh);vi.renderOrder=1;function Gy(){const n=kn(_t.position.x,_t.position.z),t=Math.max(n,jt.waterLevel),e=Math.max(0,_t.position.y-t);vi.position.x=_t.position.x,vi.position.z=_t.position.z,vi.position.y=t+.04;const i=Math.min(1,e/zy),s=Math.min(1,e/ky);Zh.opacity=jh*s*(1-.85*i);const r=1+i*.4;vi.scale.set(r,1,r),vi.visible=_t.position.y>t-.5}const ln=new D(0,0,-1),Mu=new D,Su=new D,He=new D,fn=new D,fs=new D,Eu=new D;function Kh(){switch(G.flightState){case ne.PRELAUNCH:case ne.LANDED:return 0;case ne.TAKEOFF_ROLL:case ne.LANDING_ROLL:return Gs.clamp(G.speed/jn.takeoffSpeed,0,1);default:return 1}}function Os(n,t,e){return n+(t-n)*e}let so=0;function Pr(n,t){return 1-Math.exp(-t/Math.max(n,1e-4))}function Hy(n){const t=1-n;return 1-t*t*t}function Vy(n){return fn.set(0,0,-1).applyQuaternion(_t.quaternion),He.set(fn.x,0,fn.z),He.lengthSq()<1e-4&&He.set(0,0,-1),He.normalize(),fs.set(0,We.height,0),n.copy(_t.position).addScaledVector(He,-6.5).add(fs)}function Wy(n){if(G.flightState===ne.INTRO&&G.introStartCamPos){const u=Hy(Math.min(1,G.introT));Vy(Eu),yn.position.lerpVectors(G.introStartCamPos,Eu,u),yn.up.set(0,1,0),yn.lookAt(_t.position);return}fn.set(0,0,-1).applyQuaternion(_t.quaternion);const t=Pr(We.yawTau,n),e=Pr(We.pitchTau,n);ln.x+=(fn.x-ln.x)*t,ln.z+=(fn.z-ln.z)*t,ln.y+=(fn.y-ln.y)*e,ln.normalize(),He.set(ln.x,0,ln.z),He.lengthSq()<1e-4&&He.set(0,0,-1),He.normalize();const i=G.greyActive||G.oneShotActive?1:0,s=Pr(Pe.camPushbackTau,n);so+=(i-so)*s;const r=Kh(),o=Os(We.runwayDistance,We.distance,r),a=Os(We.runwayHeight,We.height,r),l=Os(We.runwayLookAhead,We.lookAhead,r);fs.set(0,a,0),Mu.copy(_t.position).addScaledVector(He,-(o+Pe.camPushback*so)).add(fs);const c=Pr(We.posTau,n);yn.position.lerp(Mu,c),Su.copy(_t.position).addScaledVector(ln,l),yn.up.set(0,1,0),yn.lookAt(Su)}function Qo(){fn.set(0,0,-1).applyQuaternion(_t.quaternion),ln.copy(fn),He.set(fn.x,0,fn.z),He.lengthSq()<1e-4&&He.set(0,0,-1),He.normalize();const n=Kh(),t=Os(We.runwayDistance,We.distance,n),e=Os(We.runwayHeight,We.height,n);fs.set(0,e,0),yn.position.copy(_t.position).addScaledVector(He,-t).add(fs)}let Or=null;const xn=new D,bu=new D,Tu=new D,Au=new Ve,wu=new gn,Lr=new D,Cu=new D,Xy=new D;function ua(n,t=Xy){return t.set(0,0,-1).applyEuler(new gn(0,n,0))}function qy(n){const t=ua(n.activeHeading);_t.position.set(n.x-t.x*n.length*.45,n.elevation+.22,n.z-t.z*n.length*.45),_t.quaternion.setFromEuler(new gn(0,n.activeHeading,0)),G.speed=0,G.flightState=ne.PRELAUNCH,G.currentRunway=n,G.refillStartGrey=G.boostFuelGrey,G.refillStartOneshot=G.boostFuelOneshot,G.refillT=0,G.greyActive=!1,G.oneShotActive=!1,G.prevOneShot=!1,Qo()}const Jh=document.getElementById("crash");function Yy(){G.flightPunkte=0}function Qh(){G.flightPunkte>St.bestFlightPunkte&&(St.bestFlightPunkte=G.flightPunkte),G.flightPunkte=0}function Br(){G.alive&&(G.alive=!1,G.flightState=ne.CRASHED,Qh(),ri(),Jh.classList.add("visible"))}function td(){const n=St.checkpointRunwayId??ld,t=mn.find(i=>i.id===n)??mn[0],e=!St.introPlayed;if(cd(),Iy(),Ny(),Oy(),Hh(),Jh.classList.remove("visible"),qy(t),e){const i=new D(0,0,-1).applyQuaternion(_t.quaternion),s=new D(i.x,0,i.z).normalize();G.introStartCamPos=_t.position.clone().addScaledVector(s,-4e3).add(new D(0,Pu.startHeight,0)),G.introT=0,G.flightState=ne.INTRO,Ie.fog&&(Or=Ie.fog,Ie.fog=null)}}function jy(){return me.down||me.up||me.left||me.right||me.brake}function ed(n){if(G.refillT>=1)return;G.refillT=Math.min(1,G.refillT+n/Pe.refillDuration);const t=G.refillT;G.boostFuelGrey=G.refillStartGrey+(1-G.refillStartGrey)*t,G.boostFuelOneshot=G.refillStartOneshot+(1-G.refillStartOneshot)*t}function $y(){G.refillT=1,G.boostFuelGrey=1,G.boostFuelOneshot=1}function Zy(n){const t=me.oneShot&&!G.prevOneShot;G.prevOneShot=me.oneShot,t&&wi()>0&&G.boostFuelOneshot>0&&!G.oneShotActive&&(G.oneShotActive=!0),G.greyActive=me.boost&&G.boostFuelGrey>0;let e=0,i=0;if(G.oneShotActive){const s=Pe.oneShot.tiers[wi()]||Pe.oneShot.tiers[0];G.boostFuelOneshot-=n/Math.max(s.tankDuration,1e-4),G.boostFuelOneshot<=0?(G.boostFuelOneshot=St.testMode?1:0,G.oneShotActive=!1):(e+=s.speedBonus,i+=s.accelRate)}if(G.greyActive){const s=Pe.grey;G.boostFuelGrey-=n/Math.max(s.tankDuration,1e-4),G.boostFuelGrey<=0?(G.boostFuelGrey=0,G.greyActive=!1):(e+=s.speedBonus,i+=s.accelRate)}return!G.greyActive&&!G.oneShotActive&&G.boostFuelGrey<1&&(G.boostFuelGrey=Math.min(1,G.boostFuelGrey+n/Pe.grey.rechargeTime)),{speedBonus:e,accelBonus:i}}function Ky(n){jy()?G.introT=1:G.introT+=n/Pu.duration,G.introT>=1&&(G.introT=0,G.introStartCamPos=null,G.flightState=ne.PRELAUNCH,St.introPlayed=!0,Or&&(Ie.fog=Or,Or=null),Qo())}function Jy(n){ed(n),me.down&&(G.flightState=ne.TAKEOFF_ROLL,G.takeoffTime=0,Yy())}function Qy(n){const t=G.currentRunway;G.takeoffTime+=n,ed(n);const e=jn.takeoffSpeed,i=jn.linearShare,s=1-i,o=t.length*jn.liftoffFraction/(e*(i/2+s/3)),a=Math.min(1,G.takeoffTime/o);G.speed=e*(i*a+s*a*a);const l=ua(t.activeHeading);_t.position.x+=l.x*G.speed*n,_t.position.z+=l.z*G.speed*n,_t.position.y=t.elevation+.22,_t.quaternion.setFromEuler(new gn(0,t.activeHeading,0)),a>=1&&(_t.rotateX(jn.pitchUpAtLiftoff),G.flightState=ne.FLYING,G.currentRunway=null,G.postLiftCooldown=1.2,$y())}function tM(n){const t=Zy(n),e=(me.down?1:0)-(me.up?1:0),i=(me.right?1:0)-(me.left?1:0),s=Math.max(0,pe.stallSpeed-G.speed)/pe.stallSpeed,r=1-s*(1-pe.stallAuthority),o=e*r;xn.set(0,0,-1).applyQuaternion(_t.quaternion);const a=Math.asin(Gs.clamp(xn.y,-1,1));let l=o*pe.pitchRate*n;l>0&&(l=Math.min(l,Math.max(0,pe.maxClimbPitch-a))),_t.rotateX(l),_t.rotateZ(-i*pe.rollRate*n),xn.set(0,0,-1).applyQuaternion(_t.quaternion),bu.set(1,0,0).applyQuaternion(_t.quaternion),Tu.set(0,1,0).applyQuaternion(_t.quaternion);const c=Math.atan2(bu.y,Tu.y);_t.rotateOnWorldAxis(Zc,Math.sin(c)*pe.turnFactor*n),s>.01&&(Lr.set(xn.x,0,xn.z),Lr.lengthSq()>1e-4&&(Lr.normalize(),Cu.crossVectors(Lr,Zc).normalize(),_t.rotateOnWorldAxis(Cu,-s*pe.stallPitchRate*n))),xn.set(0,0,-1).applyQuaternion(_t.quaternion);const u=xn.y;G.speed-=u*pe.speedFromPitch*n,G.speed-=pe.drag*n,G.brakeAmount>.01&&(G.speed-=G.brakeAmount*ro.force*n);const h=Zv(_t.position.x,_t.position.y,_t.position.z);G.speed+=h*.13*n,G.inThermal=h>.5;const f=pe.maxSpeed+t.speedBonus;t.accelBonus>0&&G.speed<f&&(G.speed=Math.min(f,G.speed+t.accelBonus*n)),G.speed=Math.max(pe.minSpeed,Math.min(f,G.speed));const m=_t.position.x,x=_t.position.z;_t.position.addScaledVector(xn,G.speed*n);const v=pe.sinkRate*(1+s*pe.stallSink);_t.position.y-=v*n,_t.position.y+=h*n;const p=_t.position.x-m,d=_t.position.z-x;ta(Math.sqrt(p*p+d*d));const y=jt.size/2-30;if(_t.position.x>y&&(_t.position.x=y),_t.position.x<-y&&(_t.position.x=-y),_t.position.z>y&&(_t.position.z=y),_t.position.z<-y&&(_t.position.z=-y),G.postLiftCooldown>0){G.postLiftCooldown-=n;return}const _=Math.atan2(-xn.x,-xn.z),S=lv(_t.position,_);if(S){G.flightState=ne.LANDING_ROLL,G.currentRunway=S,_t.position.y=S.elevation+.22;return}const L=cv(_t.position);if(L&&_t.position.y-L.elevation<Ai.rollingHeight){Br();return}const A=kn(_t.position.x,_t.position.z);(_t.position.y<Math.max(A+.4,jt.waterLevel+.4)||Av(_t.position.x,_t.position.y,_t.position.z))&&Br()}function eM(n){const t=G.currentRunway;G.speed=Math.max(0,G.speed-Ai.brakeForce*n);const e=ua(t.activeHeading),i=_t.position.x,s=_t.position.z;_t.position.x+=e.x*G.speed*n,_t.position.z+=e.z*G.speed*n,_t.position.y=t.elevation+.22;const r=_t.position.x-i,o=_t.position.z-s;ta(Math.sqrt(r*r+o*o)),wu.set(0,t.activeHeading,0),Au.setFromEuler(wu),_t.quaternion.slerp(Au,.22);const a=_t.position.x-t.x,l=_t.position.z-t.z,c=a*Math.sin(t.heading)+l*Math.cos(t.heading);if(Math.abs(c)>t.length*.5){Br();return}G.speed<Ai.landingSpeed&&nM(t)}function nM(n){G.speed=0,G.flightState=ne.LANDED,G.landedToastTimer=Lu.toastDuration,G.cinematicT=0,G.cinematicFromPos=_t.position.clone(),G.cinematicFromQuat=_t.quaternion.clone();const t=n.activeHeading,e=ua(t,new D);G.cinematicToPos=new D(n.x-e.x*n.length*.45,n.elevation+.22,n.z-e.z*n.length*.45),G.cinematicToQuat=new Ve().setFromEuler(new gn(0,t,0)),St.landings+=1,ta(Ai.landingBonus),St.checkpointRunwayId=n.id,Qh(),ri(),cy(n)}function iM(n){return n<.5?4*n*n*n:1-Math.pow(-2*n+2,3)/2}function sM(n){if(G.landedToastTimer>0){G.landedToastTimer-=n;return}if(G.cinematicT+=n/Lu.tweenDuration,G.cinematicT>=1){_t.position.copy(G.cinematicToPos),_t.quaternion.copy(G.cinematicToQuat),G.cinematicT=0,G.cinematicFromPos=null,G.cinematicToPos=null,G.cinematicFromQuat=null,G.cinematicToQuat=null,G.flightState=ne.PRELAUNCH,G.refillStartGrey=G.boostFuelGrey,G.refillStartOneshot=G.boostFuelOneshot,G.refillT=0,Qo(),Hh();return}const t=iM(G.cinematicT);_t.position.lerpVectors(G.cinematicFromPos,G.cinematicToPos,t),_t.quaternion.copy(G.cinematicFromQuat)}function rM(n){if(G.alive)switch(G.flightState){case ne.INTRO:return Ky(n);case ne.PRELAUNCH:return Jy(n);case ne.TAKEOFF_ROLL:return Qy(n);case ne.FLYING:return tM(n);case ne.LANDING_ROLL:return eM(n);case ne.LANDED:return sM(n);case ne.CRASHED:return}}Ed();yd();fd();qs();await Promise.all([vv(),pv()]);mn.forEach(n=>{n.elevation=Zo(n.x,n.z)});Ie.add(Sv());Ie.add(Ev());Ie.add(Vv());Ie.add(hv());Ie.add(jv());Ie.add(vy());Ie.add(vi);Ie.add(_t);Ay();document.getElementById("restart-btn").addEventListener("click",td);td();requestAnimationFrame(()=>{const n=document.getElementById("loading-screen");n&&(n.classList.add("hidden"),setTimeout(()=>n.remove(),600))});let Ru=performance.now();function nd(n){requestAnimationFrame(nd);const t=Math.min(.05,(n-Ru)/1e3);Ru=n,rM(t),Ly(t),Dy(t),Fy(t),Py(),Gy(),dv(n/1e3),$v(t),by(t,_t),Ry(_t),Wy(t),dy(),gs.render(Ie,yn)}requestAnimationFrame(nd);
