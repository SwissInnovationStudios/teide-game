...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function Qa(){return new Hn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fo(),fragmentShader:`
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function tc(){return new Hn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fo(),fragmentShader:`
	...
	`}function Hp(n){let t=new WeakMap,e=null;function i(o){if(o&&o.isTexture){const c=o.mapping,l=c===fo||c===po,u=c===Oi||c===Bi;if(l||u)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let h=t.get(o);return e===null&&(e=new $a(n)),h=l?e.fromEquirectangular(o,h):e.fromCubemap(o,h),t.set(o,h),h.texture}else{if(t.has(o))return t.get(o).texture;{const h=o.image;if(l&&h&&h.height>0||u&&h&&r(h)){e===null&&(e=new $a(n));const f=l?e.fromEquirectangular(o):e.fromCubemap(o);return t.set(o,f),o.addEventListener("dispose",s),f.texture}else return null}}}return o}function r(o){let c=0;const l=6;for(let u=0;u<l;u++)o[u]!==void 0&&c++;return c===l}function s(o){const c=o.target;c.removeEventListener("dispose",s);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:i,dispose:a}}function Vp(n){const t={};function e(i){if(t[i]!==void 0)return t[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return t[i]=r,r}return{has:function(i){return e(i)!==null},init:function(i){i.isWebGL2?(e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance")):(e("WEBGL_depth_texture"),e("OES_texture_float"),e("OES_texture_half_float"),e("OES_texture_half_float_linear"),e("OES_standard_derivatives"),e("OES_element_index_uint"),e("OES_vertex_array_object"),e("ANGLE_instanced_arrays")),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture")},get:function(i){const r=e(i);return r===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function kp(n,t,e,i){const r={},s=new WeakMap;function a(h){const f=h.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let p=0,d=_.length;p<d;p++)t.remove(_[p])}f.removeEventListener("dispose",a),delete r[f.id];const m=s.get(f);m&&(t.remove(m),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(h,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,e.memory.geometries++),f}function c(h){const f=h.attributes;for(const g in f)t.update(f[g],n.ARRAY_BUFFER);const m=h.morphAttributes;for(const g in m){const _=m[g];for(let p=0,d=_.length;p<d;p++)t.update(_[p],n.ARRAY_BUFFER)}}function l(h){const f=[],m=h.index,g=h.attributes.position;let _=0;if(m!==null){const S=m.array;_=m.version;for(let v=0,T=S.length;v<T;v+=3){const L=S[v+0],b=S[v+1],w=S[v+2];f.push(L,b,b,w,w,L)}}else if(g!==void 0){const S=g.array;_=g.version;for(let v=0,T=S.length/3-1;v<T;v+=3){const L=v+0,b=v+1,w=v+2;f.push(L,b,b,w,w,L)}}else return;const p=new(hl(f)?vl:_l)(f,1);p.version=_;const d=s.get(h);d&&t.remove(d),s.set(h,p)}function u(h){const f=s.get(h);if(f){const m=h.index;m!==null&&f.version<m.version&&l(h)}else l(h);return s.get(h)}return{get:o,update:c,getWireframeAttribute:u}}function Wp(n,t,e,i){const r=i.isWebGL2;let s;function a(m){s=m}let o,c;function l(m){o=m.type,c=m.bytesPerElement}function u(m,g){n.drawElements(s,g,o,m*c),e.update(g,s,1)}function h(m,g,_){if(_===0)return;let p,d;if(r)p=n,d="drawElementsInstanced";else if(p=t.get("ANGLE_instanced_arrays"),d="drawElementsInstancedANGLE",p===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}p[d](s,g,o,m*c,_),e.update(g,s,_)}function f(m,g,_){if(_===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let d=0;d<_;d++)this.render(m[d]/c,g[d]);else{p.multiDrawElementsWEBGL(s,g,0,o,m,0,_);let d=0;for(let S=0;S<_;S++)d+=g[S];e.update(d,s,1)}}this.setMode=a,this.setIndex=l,this.render=u,this.renderInstances=h,this.renderMultiDraw=f}function Xp(n){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(e.calls++,a){case n.TRIANGLES:e.triangles+=o*(s/3);break;case n.LINES:e.lines+=o*(s/2);break;case n.LINE_STRIP:e.lines+=o*(s-1);break;case n.LINE_LOOP:e.lines+=o*s;break;case n.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:i}}function qp(n,t){return n[0]-t[0]}function Yp(n,t){return Math.abs(t[1])-Math.abs(n[1])}function Zp(n,t,e){const i={},r=new Float32Array(8),s=new WeakMap,a=new ve,o=[];for(let l=0;l<8;l++)o[l]=[l,0];function c(l,u,h){const f=l.morphTargetInfluences;if(t.isWebGL2===!0){const m=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,g=m!==void 0?m.length:0;let _=s.get(u);if(_===void 0||_.count!==g){let P=function(){k.dispose(),s.delete(u),u.removeEventListener("dispose",P)};_!==void 0&&_.texture.dispose();const S=u.morphAttributes.position!==void 0,v=u.morphAttributes.normal!==void 0,T=u.morphAttributes.color!==void 0,L=u.morphAttributes.position||[],b=u.morphAttributes.normal||[],w=u.morphAttributes.color||[];let G=0;S===!0&&(G=1),v===!0&&(G=2),T===!0&&(G=3);let M=u.attributes.position.count*G,A=1;M>t.maxTextureSize&&(A=Math.ceil(M/t.maxTextureSize),M=t.maxTextureSize);const B=new Float32Array(M*A*4*g),k=new pl(B,M,A,g);k.type=In,k.needsUpdate=!0;const nt=G*4;for(let U=0;U<g;U++){const V=L[U],Y=b[U],q=w[U],X=M*A*4*U;for(let $=0;$<V.count;$++){const tt=$*nt;S===!0&&(a.fromBufferAttribute(V,$),B[X+tt+0]=a.x,B[X+tt+1]=a.y,B[X+tt+2]=a.z,B[X+tt+3]=0),v===!0&&(a.fromBufferAttribute(Y,$),B[X+tt+4]=a.x,B[X+tt+5]=a.y,B[X+tt+6]=a.z,B[X+tt+7]=0),T===!0&&(a.fromBufferAttribute(q,$),B[X+tt+8]=a.x,B[X+tt+9]=a.y,B[X+tt+10]=a.z,B[X+tt+11]=q.itemSize===4?a.w:1)}}_={count:g,texture:k,size:new dt(M,A)},s.set(u,_),u.addEventListener("dispose",P)}let p=0;for(let S=0;S<f.length;S++)p+=f[S];const d=u.morphTargetsRelative?1:1-p;h.getUniforms().setValue(n,"morphTargetBaseInfluence",d),h.getUniforms().setValue(n,"morphTargetInfluences",f),h.getUniforms().setValue(n,"morphTargetsTexture",_.texture,e),h.getUniforms().setValue(n,"morphTargetsTextureSize",_.size)}else{const m=f===void 0?0:f.length;let g=i[u.id];if(g===void 0||g.length!==m){g=[];for(let v=0;v<m;v++)g[v]=[v,0];i[u.id]=g}for(let v=0;v<m;v++){const T=g[v];T[0]=v,T[1]=f[v]}g.sort(Yp);for(let v=0;v<8;v++)v<m&&g[v][1]?(o[v][0]=g[v][0],o[v][1]=g[v][1]):(o[v][0]=Number.MAX_SAFE_INTEGER,o[v][1]=0);o.sort(qp);const _=u.morphAttributes.position,p=u.morphAttributes.normal;let d=0;for(let v=0;v<8;v++){const T=o[v],L=T[0],b=T[1];L!==Number.MAX_SAFE_INTEGER&&b?(_&&u.getAttribute("morphTarget"+v)!==_[L]&&u.setAttribute("morphTarget"+v,_[L]),p&&u.getAttribute("morphNormal"+v)!==p[L]&&u.setAttribute("morphNormal"+v,p[L]),r[v]=b,d+=b):(_&&u.hasAttribute("morphTarget"+v)===!0&&u.deleteAttribute("morphTarget"+v),p&&u.hasAttribute("morphNormal"+v)===!0&&u.deleteAttribute("morphNormal"+v),r[v]=0)}const S=u.morphTargetsRelative?1:1-d;h.getUniforms().setValue(n,"morphTargetBaseInfluence",S),h.getUniforms().setValue(n,"morphTargetInfluences",r)}}return{update:c}}function Jp(n,t,e,i){let r=new WeakMap;function s(c){const l=i.render.frame,u=c.geometry,h=t.get(c,u);if(r.get(h)!==l&&(t.update(h),r.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),r.get(c)!==l&&(e.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==l&&(f.update(),r.set(f,l))}return h}function a(){r=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:s,dispose:a}}class Tl extends Ge{constructor(t,e,i,r,s,a,o,c,l,u){if(u=u!==void 0?u:ii,u!==ii&&u!==zi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===ii&&(i=Un),i===void 0&&u===zi&&(i=ni),super(null,r,s,a,o,c,u,i,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Ie,this.minFilter=c!==void 0?c:Ie,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const Al=new Ge,bl=new Tl(1,1);bl.compareFunction=ul;const wl=new pl,Rl=new Dh,Cl=new Sl,ec=[],nc=[],ic=new Float32Array(16),rc=new Float32Array(9),sc=new Float32Array(4);function Xi(n,t,e){const i=n[0];if(i<=0||i>0)return n;const r=t*e;let s=ec[r];if(s===void 0&&(s=new Float32Array(r),ec[r]=s),t!==0){i.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,n[a].toArray(s,o)}return s}function he(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function fe(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function ds(n,t){let e=nc[t];e===void 0&&(e=new Int32Array(t),nc[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function Kp(n,t){const e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function $p(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(he(e,t))return;n.uniform2fv(this.addr,t),fe(e,t)}}function jp(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(he(e,t))return;n.uniform3fv(this.addr,t),fe(e,t)}}function Qp(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(he(e,t))return;n.uniform4fv(this.addr,t),fe(e,t)}}function tm(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(he(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),fe(e,t)}else{if(he(e,i))return;sc.set(i),n.uniformMatrix2fv(this.addr,!1,sc),fe(e,i)}}function em(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(he(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),fe(e,t)}else{if(he(e,i))return;rc.set(i),n.uniformMatrix3fv(this.addr,!1,rc),fe(e,i)}}function nm(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(he(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),fe(e,t)}else{if(he(e,i))return;ic.set(i),n.uniformMatrix4fv(this.addr,!1,ic),fe(e,i)}}function im(n,t){const e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function rm(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(he(e,t))return;n.uniform2iv(this.addr,t),fe(e,t)}}function sm(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(he(e,t))return;n.uniform3iv(this.addr,t),fe(e,t)}}function om(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(he(e,t))return;n.uniform4iv(this.addr,t),fe(e,t)}}function am(n,t){const e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function cm(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(he(e,t))return;n.uniform2uiv(this.addr,t),fe(e,t)}}function lm(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(he(e,t))return;n.uniform3uiv(this.addr,t),fe(e,t)}}function um(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(he(e,t))return;n.uniform4uiv(this.addr,t),fe(e,t)}}function hm(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);const s=this.type===n.SAMPLER_2D_SHADOW?bl:Al;e.setTexture2D(t||s,r)}function fm(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture3D(t||Rl,r)}function dm(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTextureCube(t||Cl,r)}function pm(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture2DArray(t||wl,r)}function mm(n){switch(n){case 5126:return Kp;case 35664:return $p;case 35665:return jp;case 35666:return Qp;case 35674:return tm;case 35675:return em;case 35676:return nm;case 5124:case 35670:return im;case 35667:case 35671:return rm;case 35668:case 35672:return sm;case 35669:case 35673:return om;case 5125:return am;case 36294:return cm;case 36295:return lm;case 36296:return um;case 35678:case 36198:case 36298:case 36306:case 35682:return hm;case 35679:case 36299:case 36307:return fm;case 35680:case 36300:case 36308:case 36293:return dm;case 36289:case 36303:case 36311:case 36292:return pm}}function gm(n,t){n.uniform1fv(this.addr,t)}function _m(n,t){const e=Xi(t,this.size,2);n.uniform2fv(this.addr,e)}function vm(n,t){const e=Xi(t,this.size,3);n.uniform3fv(this.addr,e)}function xm(n,t){const e=Xi(t,this.size,4);n.uniform4fv(this.addr,e)}function Mm(n,t){const e=Xi(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function Sm(n,t){const e=Xi(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function ym(n,t){const e=Xi(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function Em(n,t){n.uniform1iv(this.addr,t)}function Tm(n,t){n.uniform2iv(this.addr,t)}function Am(n,t){n.uniform3iv(this.addr,t)}function bm(n,t){n.uniform4iv(this.addr,t)}function wm(n,t){n.uniform1uiv(this.addr,t)}function Rm(n,t){n.uniform2uiv(this.addr,t)}function Cm(n,t){n.uniform3uiv(this.addr,t)}function Lm(n,t){n.uniform4uiv(this.addr,t)}function Pm(n,t,e){const i=this.cache,r=t.length,s=ds(e,r);he(i,s)||(n.uniform1iv(this.addr,s),fe(i,s));for(let a=0;a!==r;++a)e.setTexture2D(t[a]||Al,s[a])}function Dm(n,t,e){const i=this.cache,r=t.length,s=ds(e,r);he(i,s)||(n.uniform1iv(this.addr,s),fe(i,s));for(let a=0;a!==r;++a)e.setTexture3D(t[a]||Rl,s[a])}function Um(n,t,e){const i=this.cache,r=t.length,s=ds(e,r);he(i,s)||(n.uniform1iv(this.addr,s),fe(i,s));for(let a=0;a!==r;++a)e.setTextureCube(t[a]||Cl,s[a])}function Im(n,t,e){const i=this.cache,r=t.length,s=ds(e,r);he(i,s)||(n.uniform1iv(this.addr,s),fe(i,s));for(let a=0;a!==r;++a)e.setTexture2DArray(t[a]||wl,s[a])}function Nm(n){switch(n){case 5126:return gm;case 35664:return _m;case 35665:return vm;case 35666:return xm;case 35674:return Mm;case 35675:return Sm;case 35676:return ym;case 5124:case 35670:return Em;case 35667:case 35671:return Tm;case 35668:case 35672:return Am;case 35669:case 35673:return bm;case 5125:return wm;case 36294:return Rm;case 36295:return Cm;case 36296:return Lm;case 35678:case 36198:case 36298:case 36306:case 35682:return Pm;case 35679:case 36299:case 36307:return Dm;case 35680:case 36300:case 36308:case 36293:return Um;case 36289:case 36303:case 36311:case 36292:return Im}}class Fm{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=mm(e.type)}}class Om{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Nm(e.type)}}class Bm{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(t,e[o.id],i)}}}const js=/(\w+)(\])?(\[|\.)?/g;function oc(n,t){n.seq.push(t),n.map[t.id]=t}function zm(n,t,e){const i=n.name,r=i.length;for(js.lastIndex=0;;){const s=js.exec(i),a=js.lastIndex;let o=s[1];const c=s[2]==="]",l=s[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===r){oc(e,l===void 0?new Fm(o,n,t):new Om(o,n,t));break}else{let h=e.map[o];h===void 0&&(h=new Bm(o),oc(e,h)),e=h}}}class $r{constructor(t,e){this.seq=[],this.map={};const i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=t.getActiveUniform(e,r),a=t.getUniformLocation(e,s.name);zm(s,a,this)}}setValue(t,e,i,r){const s=this.map[e];s!==void 0&&s.setValue(t,i,r)}setOptional(t,e,i){const r=e[i];r!==void 0&&this.setValue(t,i,r)}static upload(t,e,i,r){for(let s=0,a=e.length;s!==a;++s){const o=e[s],c=i[o.id];c.needsUpdate!==!1&&o.setValue(t,c.value,r)}}static seqWithValue(t,e){const i=[];for(let r=0,s=t.length;r!==s;++r){const a=t[r];a.id in e&&i.push(a)}return i}}function ac(n,t,e){const i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}const Gm=37297;let Hm=0;function Vm(n,t){const e=n.split(`
`),i=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=r;a<s;a++){const o=a+1;i.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return i.join(`
`)}function km(n){const t=Jt.getPrimaries(Jt.workingColorSpace),e=Jt.getPrimaries(n);let i;switch(t===e?i="":t===rs&&e===is?i="LinearDisplayP3ToLinearSRGB":t===is&&e===rs&&(i="LinearSRGBToLinearDisplayP3"),n){case En:case fs:return[i,"LinearTransferOETF"];case _e:case Do:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function cc(n,t,e){const i=n.getShaderParameter(t,n.COMPILE_STATUS),r=n.getShaderInfoLog(t).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+Vm(n.getShaderSource(t),a)}else return r}function Wm(n,t){const e=km(t);return`vec4 ${n}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Xm(n,t){let e;switch(t){case Vu:e="Linear";break;case ku:e="Reinhard";break;case Wu:e="OptimizedCineon";break;case Xu:e="ACESFilmic";break;case Yu:e="AgX";break;case qu:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function qm(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Di).join(`
`)}function Ym(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(Di).join(`
`)}function Zm(n){const t=[];for(const e in n){const i=n[e];i!==!1&&t.push("#define "+e+" "+i)}return t.join(`
`)}function Jm(n,t){const e={},i=n.getProgramParameter(t,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(t,r),a=s.name;let o=1;s.type===n.FLOAT_MAT2&&(o=2),s.type===n.FLOAT_MAT3&&(o=3),s.type===n.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:n.getAttribLocation(t,a),locationSize:o}}return e}function Di(n){return n!==""}function lc(n,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function uc(n,t){return n.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Km=/^[ \t]*#include +<([\w\d./]+)>/gm;function xo(n){return n.replace(Km,jm)}const $m=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function jm(n,t){let e=Nt[t];if(e===void 0){const i=$m.get(t);if(i!==void 0)e=Nt[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,i);else throw new Error("Can not resolve #include <"+t+">")}return xo(e)}const Qm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function hc(n){return n.replace(Qm,tg)}function tg(n,t,e,i){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function fc(n){let t="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?t+=`
#define HIGH_PRECISION`:n.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function eg(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Qc?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===gu?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Sn&&(t="SHADOWMAP_TYPE_VSM"),t}function ng(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Oi:case Bi:t="ENVMAP_TYPE_CUBE";break;case hs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function ig(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Bi:t="ENVMAP_MODE_REFRACTION";break}return t}function rg(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Lo:t="ENVMAP_BLENDING_MULTIPLY";break;case Gu:t="ENVMAP_BLENDING_MIX";break;case Hu:t="ENVMAP_BLENDING_ADD";break}return t}function sg(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function og(n,t,e,i){const r=n.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=eg(e),l=ng(e),u=ig(e),h=rg(e),f=sg(e),m=e.isWebGL2?"":qm(e),g=Ym(e),_=Zm(s),p=r.createProgram();let d,S,v=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `});return us=new Og(s,a),n.add(us),n}function i0(n){if(!us)return;const t=us.geometry.attributes.position,e=t.array,i=ke.columnTop,r=ke.riseSpeed;for(let s=0;s<Pn.length;s++){const a=ti[wo[s]];Pn[s]+=r*a.strength/i*n,Pn[s]>=1&&(Pn[s]-=1);const o=a.radius*(ls+(tu-ls)*Pn[s]);e[s*3+0]=a.x+jr[s]*o,e[s*3+1]=a.baseElevation+Pn[s]*i,e[s*3+2]=a.z+Qr[s]*o}t.needsUpdate=!0}function r0(n,t,e){let i=0;for(const r of ti){const s=n-r.x,a=e-r.z,o=Math.sqrt(s*s+a*a);if(o>=r.radius)continue;const c=t-(r.baseElevation??0);if(c<0)continue;const l=1-o/r.radius,u=Math.max(0,1-c/ke.maxAltitude);i+=ke.liftAtCenter*r.strength*l*u}return i}const ie={INTRO:"INTRO",PRELAUNCH:"PRELAUNCH",TAKEOFF_ROLL:"TAKEOFF_ROLL",FLYING:"FLYING",LANDING_ROLL:"LANDING_ROLL",LANDED:"LANDED",CRASHED:"CRASHED"},W={speed:ge.startSpeed,alive:!0,inThermal:!1,brakeAmount:0,gearAmount:0,flightState:ie.PRELAUNCH,currentRunway:null,takeoffTime:0,postLiftCooldown:0,landedToastTimer:0,cinematicT:0,cinematicFromPos:null,cinematicToPos:null,cinematicFromQuat:null,cinematicToQuat:null,introT:0,introStartCamPos:null},Je={score:0,landings:0,checkpointRunwayId:null,introPlayed:!1};function s0(){W.speed=ge.startSpeed,W.alive=!0,W.inThermal=!1,W.brakeAmount=0,W.gearAmount=0,W.flightState=ie.PRELAUNCH,W.currentRunway=null,W.takeoffTime=0,W.postLiftCooldown=0,W.landedToastTimer=0,W.cinematicT=0,W.cinematicFromPos=null,W.cinematicToPos=null,W.cinematicFromQuat=null,W.cinematicToQuat=null,W.introT=0,W.introStartCamPos=null,Je.score=0,Je.landings=0}const eu=[];(function(){for(const t of[-.95,.95]){const e=new Float32Array(Dn.verts*3),i=new Float32Array(Dn.verts*3);for(let o=0;o<Dn.verts;o++){const c=o/(Dn.verts-1);e[o*3]=t,e[o*3+1]=-.05,e[o*3+2]=.42+c*Dn.maxLen;const l=1-c;i[o*3]=l,i[o*3+1]=l,i[o*3+2]=l}const r=new ye;r.setAttribute("position",new Se(e,3)),r.setAttribute("color",new Se(i,3));const s=new ps({vertexColors:!0,transparent:!0,opacity:0,blending:lo,depthWrite:!1}),a=new Pl(r,s);et.add(a),eu.push(a)}})();function o0(){const n=ge.stallSpeed+3,t=ge.maxSpeed*.7,e=as.clamp((W.speed-n)/(t-n),0,1),i=Dn.maxLen*(.3+e*.7);for(const r of eu){const s=r.geometry.attributes.position.array;for(let a=0;a<Dn.verts;a++){const o=a/(Dn.verts-1);s[a*3+2]=.42+o*i}r.geometry.attributes.position.needsUpdate=!0,r.material.opacity=e*.95}}const Hc=new xe,Vo=[];(function(){const i=Math.atan2(.28,.95),r=new Re({color:Xt.paper,side:Ye,flatShading:!0}),s=new ps({color:Xt.ink,transparent:!0,opacity:.32});for(const a of[-.45,.45]){const o=new xe;o.position.set(a,.045,.05),o.rotation.z=a<0?i:-i;const c=new fi(.32,.22);c.translate(0,-.22/2,0),c.rotateX(-Math.PI/2);const l=new te(c,r),u=new Ol(c);l.add(new Dl(u,s)),o.add(l),Hc.add(o),Vo.push(l)}et.add(Hc)})();function a0(n){const t=we.brake&&W.alive&&W.flightState===ie.FLYING?1:0,e=1-Math.exp(-n/Eo.deployTau);W.brakeAmount+=(t-W.brakeAmount)*e;const i=-W.brakeAmount*Eo.maxAngle;for(const r of Vo)r.rotation.x=i}function c0(){W.brakeAmount=0;for(const n of Vo)n.rotation.x=0}const dn=new xe;(function(){const t=new Re({color:Xt.ink,flatShading:!0});function e(i,r,s,a){const o=new xe,c=new Vn(.018,.018,s,6);c.translate(0,-s/2,0),o.add(new te(c,t));const l=new Vn(a,a,.04,12);return l.rotateZ(Math.PI/2),l.translate(0,-s,0),o.add(new te(l,t)),o.position.set(i,-.05,r),o}dn.add(e(0,-.55,.11,.055)),dn.add(e(-.42,.12,.12,.06)),dn.add(e(.42,.12,.12,.06)),dn.scale.setScalar(.001),dn.visible=!1,et.add(dn)})();function l0(n){const t=w_(et.position,oo.triggerDist,oo.triggerHeight)?1:0,e=1-Math.exp(-n/oo.deployTau);W.gearAmount+=(t-W.gearAmount)*e;const i=Math.max(.001,W.gearAmount);dn.scale.setScalar(i),dn.visible=W.gearAmount>.02}function u0(){W.gearAmount=0,dn.scale.setScalar(.001),dn.visible=!1}const h0=.9,nu=.55,f0=35,d0=1.6,iu=new Go(h0,28);iu.rotateX(-Math.PI/2);const ru=new Gi({color:0,transparent:!0,opacity:nu,depthWrite:!1}),ei=new te(iu,ru);ei.renderOrder=1;function p0(){const n=_s(et.position.x,et.position.z),t=Math.max(n,qt.waterLevel),e=Math.max(0,et.position.y-t);ei.position.x=et.position.x,ei.position.z=et.position.z,ei.position.y=t+.04;const i=Math.min(1,e/f0),r=Math.min(1,e/d0);ru.opacity=nu*r*(1-.85*i);const s=1+i*.4;ei.scale.set(s,1,s),ei.visible=et.position.y>t-.5}const m0=document.getElementById("pts"),g0=document.getElementById("lnd"),_0=document.getElementById("alt"),v0=document.getElementById("spd"),x0=document.getElementById("hdg"),M0=document.getElementById("lift-row"),Ro=document.getElementById("landing-toast"),S0=document.getElementById("controls-hint"),y0="↑ ↓ Pitch · ← → Bank · Space Brake",E0="↓ / S to launch",T0="Takeoff roll…";let Vc=null;const ao=new R;function er(n,t){return Math.max(0,Math.round(n)).toString().padStart(t,"0")}function A0(n){Ro.innerHTML=`Geschafft! · ${n.id}<span class="bonus">+ ${ai.landingBonus} pts</span>`,Ro.classList.add("show")}function su(){Ro.classList.remove("show")}function b0(){const n=_s(et.position.x,et.position.z);m0.textContent=er(Je.score,5),g0.textContent=er(Je.landings,2),_0.textContent=er(et.position.y-Math.max(n,qt.waterLevel),3),v0.textContent=er(W.speed,3),ao.set(0,0,-1).applyQuaternion(et.quaternion);const t=(Math.atan2(ao.x,-ao.z)*180/Math.PI+360)%360;x0.textContent=er(t,3),M0.style.opacity=W.inThermal?"0.85":"0";const e=W.flightState===ie.INTRO?"":W.flightState===ie.PRELAUNCH?E0:W.flightState===ie.TAKEOFF_ROLL?T0:y0;e!==Vc&&(S0.textContent=e,Vc=e)}const en=new R(0,0,-1),kc=new R,Wc=new R,Ne=new R,on=new R,ko=new R(0,nr.height,0),Xc=new R;function co(n,t){return 1-Math.exp(-t/Math.max(n,1e-4))}function w0(n){const t=1-n;return 1-t*t*t}function R0(n){return on.set(0,0,-1).applyQuaternion(et.quaternion),Ne.set(on.x,0,on.z),Ne.lengthSq()<1e-4&&Ne.set(0,0,-1),Ne.normalize(),n.copy(et.position).addScaledVector(Ne,-6.5).add(ko)}function C0(n){if(W.flightState===ie.INTRO&&W.introStartCamPos){const r=w0(Math.min(1,W.introT));R0(Xc),fn.position.lerpVectors(W.introStartCamPos,Xc,r),fn.up.set(0,1,0),fn.lookAt(et.position);return}on.set(0,0,-1).applyQuaternion(et.quaternion);const t=co(nr.yawTau,n),e=co(nr.pitchTau,n);en.x+=(on.x-en.x)*t,en.z+=(on.z-en.z)*t,en.y+=(on.y-en.y)*e,en.normalize(),Ne.set(en.x,0,en.z),Ne.lengthSq()<1e-4&&Ne.set(0,0,-1),Ne.normalize(),kc.copy(et.position).addScaledVector(Ne,-6.5).add(ko);const i=co(nr.posTau,n);fn.position.lerp(kc,i),Wc.copy(et.position).addScaledVector(en,nr.lookAhead),fn.up.set(0,1,0),fn.lookAt(Wc)}function Wo(){on.set(0,0,-1).applyQuaternion(et.quaternion),en.copy(on),Ne.set(on.x,0,on.z),Ne.lengthSq()<1e-4&&Ne.set(0,0,-1),Ne.normalize(),fn.position.copy(et.position).addScaledVector(Ne,-6.5).add(ko)}const un=new R,qc=new R,Yc=new R,Zc=new cn,Jc=new Tn,Kr=new R,Kc=new R,L0=new R;function Ms(n,t=L0){return t.set(0,0,-1).applyEuler(new Tn(0,n,0))}function P0(n){const t=Ms(n.activeHeading);et.position.set(n.x-t.x*n.length*.45,n.elevation+.22,n.z-t.z*n.length*.45),et.quaternion.setFromEuler(new Tn(0,n.activeHeading,0)),W.speed=0,W.flightState=ie.PRELAUNCH,W.currentRunway=n,Wo()}const ou=document.getElementById("crash");function ts(){W.alive&&(W.alive=!1,W.flightState=ie.CRASHED,ou.classList.add("visible"))}function au(){const n=Je.checkpointRunwayId??x_,t=an.find(i=>i.id===n)??an[0],e=!Je.introPlayed;if(s0(),c0(),u0(),su(),ou.classList.remove("visible"),P0(t),e){const i=new R(0,0,-1).applyQuaternion(et.quaternion),r=new R(i.x,0,i.z).normalize();W.introStartCamPos=et.position.clone().addScaledVector(r,-40).add(new R(0,kl.startHeight,0)),W.introT=0,W.flightState=ie.INTRO}}function D0(){return we.down||we.up||we.left||we.right||we.brake}function U0(n){D0()?W.introT=1:W.introT+=n/kl.duration,W.introT>=1&&(W.introT=0,W.introStartCamPos=null,W.flightState=ie.PRELAUNCH,Je.introPlayed=!0,Wo())}function I0(){we.down&&(W.flightState=ie.TAKEOFF_ROLL,W.takeoffTime=0)}function N0(n){const t=W.currentRunway;W.takeoffTime+=n;const e=Jr.takeoffSpeed,i=Jr.linearShare,r=1-i,a=t.length*Jr.liftoffFraction/(e*(i/2+r/3)),o=Math.min(1,W.takeoffTime/a);W.speed=e*(i*o+r*o*o);const c=Ms(t.activeHeading);et.position.x+=c.x*W.speed*n,et.position.z+=c.z*W.speed*n,et.position.y=t.elevation+.22,et.quaternion.setFromEuler(new Tn(0,t.activeHeading,0)),o>=1&&(et.rotateX(Jr.pitchUpAtLiftoff),W.flightState=ie.FLYING,W.currentRunway=null,W.postLiftCooldown=1.2)}function F0(n){const t=(we.down?1:0)-(we.up?1:0),e=(we.right?1:0)-(we.left?1:0),i=Math.max(0,ge.stallSpeed-W.speed)/ge.stallSpeed,r=1-i*(1-ge.stallAuthority),s=t*r;un.set(0,0,-1).applyQuaternion(et.quaternion);const a=Math.asin(as.clamp(un.y,-1,1));let o=s*ge.pitchRate*n;o>0&&(o=Math.min(o,Math.max(0,ge.maxClimbPitch-a))),et.rotateX(o),et.rotateZ(-e*ge.rollRate*n),un.set(0,0,-1).applyQuaternion(et.quaternion),qc.set(1,0,0).applyQuaternion(et.quaternion),Yc.set(0,1,0).applyQuaternion(et.quaternion);const c=Math.atan2(qc.y,Yc.y);et.rotateOnWorldAxis(Ic,c*ge.turnFactor*n),i>.01&&(Kr.set(un.x,0,un.z),Kr.lengthSq()>1e-4&&(Kr.normalize(),Kc.crossVectors(Kr,Ic).normalize(),et.rotateOnWorldAxis(Kc,-i*ge.stallPitchRate*n))),un.set(0,0,-1).applyQuaternion(et.quaternion);const l=un.y;W.speed-=l*ge.speedFromPitch*n,W.speed-=ge.drag*n,W.brakeAmount>.01&&(W.speed-=W.brakeAmount*Eo.force*n);const u=r0(et.position.x,et.position.y,et.position.z);W.speed+=u*.13*n,W.inThermal=u>.5,W.speed=Math.max(ge.minSpeed,Math.min(ge.maxSpeed,W.speed));const h=et.position.x,f=et.position.z;et.position.addScaledVector(un,W.speed*n);const m=ge.sinkRate*(1+i*ge.stallSink);et.position.y-=m*n,et.position.y+=u*n;const g=et.position.x-h,_=et.position.z-f;Je.score+=Math.sqrt(g*g+_*_);const p=qt.size/2-30;if(et.position.x>p&&(et.position.x=p),et.position.x<-p&&(et.position.x=-p),et.position.z>p&&(et.position.z=p),et.position.z<-p&&(et.position.z=-p),W.postLiftCooldown>0){W.postLiftCooldown-=n;return}const d=Math.atan2(-un.x,-un.z),S=A_(et.position,d);if(S){W.flightState=ie.LANDING_ROLL,W.currentRunway=S,et.position.y=S.elevation+.22;return}const v=b_(et.position);if(v&&et.position.y-v.elevation<ai.rollingHeight){ts();return}const T=_s(et.position.x,et.position.z);(et.position.y<Math.max(T+.4,qt.waterLevel+.4)||k_(et.position.x,et.position.y,et.position.z))&&ts()}function O0(n){const t=W.currentRunway;W.speed=Math.max(0,W.speed-ai.brakeForce*n);const e=Ms(t.activeHeading),i=et.position.x,r=et.position.z;et.position.x+=e.x*W.speed*n,et.position.z+=e.z*W.speed*n,et.position.y=t.elevation+.22;const s=et.position.x-i,a=et.position.z-r;Je.score+=Math.sqrt(s*s+a*a),Jc.set(0,t.activeHeading,0),Zc.setFromEuler(Jc),et.quaternion.slerp(Zc,.22);const o=et.position.x-t.x,c=et.position.z-t.z,l=o*Math.sin(t.heading)+c*Math.cos(t.heading);if(Math.abs(l)>t.length*.5){ts();return}W.speed<ai.landingSpeed&&B0(t)}function B0(n){W.speed=0,W.flightState=ie.LANDED,W.landedToastTimer=Wl.toastDuration,W.cinematicT=0,W.cinematicFromPos=et.position.clone(),W.cinematicFromQuat=et.quaternion.clone();const t=n.activeHeading,e=Ms(t,new R);W.cinematicToPos=new R(n.x-e.x*n.length*.45,n.elevation+.22,n.z-e.z*n.length*.45),W.cinematicToQuat=new cn().setFromEuler(new Tn(0,t,0)),Je.landings+=1,Je.score+=ai.landingBonus,Je.checkpointRunwayId=n.id,A0(n)}function z0(n){return n<.5?4*n*n*n:1-Math.pow(-2*n+2,3)/2}function G0(n){if(W.landedToastTimer>0){W.landedToastTimer-=n;return}if(W.cinematicT+=n/Wl.tweenDuration,W.cinematicT>=1){et.position.copy(W.cinematicToPos),et.quaternion.copy(W.cinematicToQuat),W.cinematicT=0,W.cinematicFromPos=null,W.cinematicToPos=null,W.cinematicFromQuat=null,W.cinematicToQuat=null,W.flightState=ie.PRELAUNCH,Wo(),su();return}const t=z0(W.cinematicT);et.position.lerpVectors(W.cinematicFromPos,W.cinematicToPos,t),et.quaternion.copy(W.cinematicFromQuat)}function H0(n){if(W.alive)switch(W.flightState){case ie.INTRO:return U0(n);case ie.PRELAUNCH:return I0();case ie.TAKEOFF_ROLL:return N0(n);case ie.FLYING:return F0(n);case ie.LANDING_ROLL:return O0(n);case ie.LANDED:return G0(n);case ie.CRASHED:return}}await Promise.all([F_(),P_()]);an.forEach(n=>{n.elevation=ki(n.x,n.z)});Ke.add(z_());Ke.add(G_());Ke.add(t0());Ke.add(R_());Ke.add(n0());Ke.add(ei);Ke.add(et);document.getElementById("restart-btn").addEventListener("click",au);au();let $c=performance.now();function cu(n){requestAnimationFrame(cu);const t=Math.min(.05,(n-$c)/1e3);$c=n,H0(t),a0(t),l0(t),o0(),p0(),C_(n/1e3),i0(t),C0(t),b0(),qi.render(Ke,fn)}requestAnimationFrame(cu);
